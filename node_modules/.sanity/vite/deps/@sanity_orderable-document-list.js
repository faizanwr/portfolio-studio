import {
  require_dist
} from "./chunk-6UACIHHP.js";
import "./chunk-XCTHCOCC.js";
import {
  usePaneRouter
} from "./chunk-KOXOOFAC.js";
...
import {
  ...
  useFloating,
  useToast
} from "./chunk-IGGR2LEH.js";
import "./chunk-TFQE6COV.js";
import {
  require_react_dom
} from "./chunk-BIZCPQXV.js";
import {
  require_jsx_runtime
    ...
    var LexoInteger = class _LexoInteger {
      ...
      subtract(other) {
        ...
        if (this.sign !== other.sign) {
          ...
          if (this.sign === -1) {
            negate2 = this.negate();
            const sum = negate2.add(other);
            return sum.negate();
          }
          negate2 = other.negate();
          return this.add(negate2);
        }
...
// node_modules/sanity-plugin-utils/node_modules/@sanity/ui/dist/theme.mjs
var colors = {
  default: {
    lightest: "hsl(0, 0%, 95%)",
    lighter: "hsl(0, 0%, 70%)",
...
function renderColorValue(str, options) {
  ...
  try {
    if (hex = mixThemeColor(hex, mixOptions), bg && node2.mix !== void 0) {
      ...
      hex = rgbToHex(mix(from, to, node2.mix));
    }
  } catch (err) {
...
// node_modules/sanity-plugin-utils/node_modules/@sanity/ui/dist/_chunks-es/_visual-editing.mjs
...
function _getResponsiveSpace(theme, props, spaceIndexes = EMPTY_ARRAY) {
  ...
  return _responsive(media, spaceIndexes, (spaceIndex) => _fillCSSObject(props, rem(space2[spaceIndex])));
}
...
function responsiveGridGapStyle(props) {
  ...
  return _responsive(media, props.$gap, (gap) => ({
    gridGap: gap ? rem(space2[gap]) : void 0
  }));
}
...
var Label = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t4;
  return $[17] !== accent || $[18] !== children || $[19] !== muted || $[20] !== ref2 || $[21] !== restProps || $[22] !== t2 || $[23] !== t3 || $[24] !== weight ? (t4 = (0, import_jsx_runtime.jsx)(StyledLabel, { "data-ui": "Label", ...restProps, $accent: accent, $align: t2, $muted: muted, $size: t3, $weight: weight, ref: ref2, children }), $[17] = accent, $[18] = children, $[19] = muted, $[20] = ref2, $[21] = restProps, $[22] = t2, $[23] = t3, $[24] = weight, $[25] = t4) : t4 = $[25], t4;
});
...
var Avatar = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t13;
  return $[32] !== T0 || $[33] !== arrowPosition || $[34] !== as || $[35] !== color2 || $[36] !== ref2 || $[37] !== restProps || $[38] !== size2 || $[39] !== status || $[40] !== t10 || $[41] !== t11 || $[42] !== t12 || $[43] !== t8 || $[44] !== title ? (t13 = (0, import_jsx_runtime.jsxs)(T0, { as, "data-as": t8, "data-ui": t9, ...restProps, $color: color2, $size: size2, "aria-label": title, "data-arrow-position": arrowPosition, "data-status": status, ref: ref2, title, children: [
    t10,
    t11,
    t12
  ] }), $[32] = T0, $[33] = arrowPosition, $[34] = as, $[35] = color2, $[36] = ref2, $[37] = restProps, $[38] = size2, $[39] = status, $[40] = t10, $[41] = t11, $[42] = t12, $[43] = t8, $[44] = title, $[45] = t13) : t13 = $[45], t13;
});
...
var AvatarCounter2 = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(20), {
    count,
    size: t0
  } = props, sizeProp = t0 === void 0 ? 1 : t0;
  let T0, T1, t1, t2, t3, t4, t5;
  if ($[0] !== ref2 || $[1] !== sizeProp) {
    const size2 = _getArrayProp(sizeProp);
    T1 = StyledAvatarCounter, t3 = size2, t4 = "AvatarCounter", t5 = ref2, T0 = Label, t1 = "span", t2 = size2.map(_temp$9), $[0] = ref2, $[1] = sizeProp, $[2] = T0, $[3] = T1, $[4] = t1, $[5] = t2, $[6] = t3, $[7] = t4, $[8] = t5;
  } else
...
AvatarCounter2.displayName = "ForwardRef(AvatarCounter)";
function _temp$9(s) {
  return s === 1 ? 1 : s === 2 ? 3 : s === 3 ? 5 : 0;
}
var BASE_STYLES = lt`
...
var AvatarStack = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  if ($[5] !== childrenProp || $[6] !== maxLengthProp || $[7] !== ref2 || $[8] !== restProps || $[9] !== sizeProp) {
    ...
    T0 = StyledAvatarStack, t2 = "AvatarStack", t3 = restProps, t4 = ref2, t5 = size2, $[20] !== len || $[21] !== size2 ? (t6 = len === 0 && (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(AvatarCounter2, { count: len, size: size2 }) }), $[20] = len, $[21] = size2, $[22] = t6) : t6 = $[22], $[23] !== extraCount || $[24] !== len || $[25] !== size2 ? (t7 = len !== 0 && extraCount > 1 && (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(AvatarCounter2, { count: extraCount, size: size2 }) }), $[23] = extraCount, $[24] = len, $[25] = size2, $[26] = t7) : t7 = $[26];
    let t10;
    $[27] !== size2 ? (t10 = (child, childIndex) => (0, import_jsx_runtime.jsx)("div", { children: (0, import_react.cloneElement)(child, {
      size: size2
    }) }, String(childIndex)), $[27] = size2, $[28] = t10) : t10 = $[28], t8 = visibleChildren.map(t10), $[5] = childrenProp, $[6] = maxLengthProp, $[7] = ref2, $[8] = restProps, $[9] = sizeProp, $[10] = T0, $[11] = t2, $[12] = t3, $[13] = t4, $[14] = t5, $[15] = t6, $[16] = t7, $[17] = t8;
  } else
...
var Box2 = (0, import_react.forwardRef)(function(props, ref2) {
...
var Text2 = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(26);
  ...
  let t6;
  return $[17] !== accent || $[18] !== muted || $[19] !== ref2 || $[20] !== restProps || $[21] !== t3 || $[22] !== t4 || $[23] !== t5 || $[24] !== weight ? (t6 = (0, import_jsx_runtime.jsx)(StyledText, { "data-ui": "Text", ...restProps, $accent: accent, $align: t3, $muted: muted, ref: ref2, $size: t4, $weight: weight, children: t5 }), $[17] = accent, $[18] = muted, $[19] = ref2, $[20] = restProps, $[21] = t3, $[22] = t4, $[23] = t5, $[24] = weight, $[25] = t6) : t6 = $[25], t6;
});
Text2.displayName = "ForwardRef(Text)";
...
var StyledBadge = dt(Box2).withConfig({
  displayName: "StyledBadge",
  componentId: "sc-5u140l-0"
})(responsiveRadiusStyle, badgeStyle);
var Badge = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t6;
  $[11] !== children || $[12] !== fontSize2 ? (t6 = (0, import_jsx_runtime.jsx)(Text2, { size: fontSize2, children }), $[11] = children, $[12] = fontSize2, $[13] = t6) : t6 = $[13];
  let t7;
  return $[14] !== ref2 || $[15] !== restProps || $[16] !== t4 || $[17] !== t5 || $[18] !== t6 || $[19] !== tone ? (t7 = (0, import_jsx_runtime.jsx)(StyledBadge, { "data-ui": "Badge", ...restProps, $tone: tone, $radius: t4, padding: t5, ref: ref2, children: t6 }), $[14] = ref2, $[15] = restProps, $[16] = t4, $[17] = t5, $[18] = t6, $[19] = tone, $[20] = t7) : t7 = $[20], t7;
});
Badge.displayName = "ForwardRef(Badge)";
var StyledFlex = dt(Box2).withConfig({
  displayName: "StyledFlex",
  componentId: "sc-oxesg3-0"
})(flexItemStyle, responsiveFlexStyle);
var Flex2 = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t6;
  return $[18] !== as || $[19] !== ref2 || $[20] !== restProps || $[21] !== t1 || $[22] !== t2 || $[23] !== t3 || $[24] !== t4 || $[25] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(StyledFlex, { "data-ui": "Flex", ...restProps, $align: t1, $direction: t2, $gap: t3, $justify: t4, $wrap: t5, forwardedAs: as, ref: ref2 }), $[18] = as, $[19] = ref2, $[20] = restProps, $[21] = t1, $[22] = t2, $[23] = t3, $[24] = t4, $[25] = t5, $[26] = t6) : t6 = $[26], t6;
});
Flex2.displayName = "ForwardRef(Flex)";
var rotate = mt`
  from {
    transform: rotate(0deg);
  }
...
`;
var StyledSpinner = dt(Text2).withConfig({
  displayName: "StyledSpinner",
  componentId: "sc-124hnd0-0"
})`& > span > svg{animation:${rotate} 500ms linear infinite;}`;
var Spinner2 = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t1;
  return $[1] !== props || $[2] !== ref2 ? (t1 = (0, import_jsx_runtime.jsx)(StyledSpinner, { "data-ui": "Spinner", ...props, ref: ref2, children: t0 }), $[1] = props, $[2] = ref2, $[3] = t1) : t1 = $[3], t1;
});
Spinner2.displayName = "ForwardRef(Spinner)";
...
function buttonBaseStyles(props) {
  ...
  return lt`
    ${style2 == null ? void 0 : style2.button};
...
function buttonColorStyles(props) {
  ...
  }, (_a = style2 == null ? void 0 : style2.button) == null ? void 0 : _a.root].filter(Boolean);
}
...
var Button2 = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t23;
  $[55] !== loading ? (t23 = !!loading && (0, import_jsx_runtime.jsx)(LoadingBox, { children: (0, import_jsx_runtime.jsx)(Spinner2, {}) }), $[55] = loading, $[56] = t23) : t23 = $[56];
  let t24;
  $[57] !== IconComponent || $[58] !== IconRightComponent || $[59] !== boxProps || $[60] !== button || $[61] !== fontSize2 || $[62] !== justify || $[63] !== muted || $[64] !== space2 || $[65] !== text || $[66] !== textAlign || $[67] !== textWeight ? (t24 = (IconComponent || text || IconRightComponent) && (0, import_jsx_runtime.jsx)(Box2, { as: "span", ...boxProps, children: (0, import_jsx_runtime.jsxs)(Flex2, { as: "span", justify, gap: space2, children: [
    IconComponent && (0, import_jsx_runtime.jsxs)(Text2, { size: fontSize2, children: [
    ...
    text && (0, import_jsx_runtime.jsx)(Box2, { children: (0, import_jsx_runtime.jsx)(Text2, { muted, align: textAlign, size: fontSize2, textOverflow: "ellipsis", weight: textWeight ?? button.textWeight, children: text }) }),
    IconRightComponent && (0, import_jsx_runtime.jsxs)(Text2, { size: fontSize2, children: [
  ...
  ] }) }), $[57] = IconComponent, $[58] = IconRightComponent, $[59] = boxProps, $[60] = button, $[61] = fontSize2, $[62] = justify, $[63] = muted, $[64] = space2, $[65] = text, $[66] = textAlign, $[67] = textWeight, $[68] = t24) : t24 = $[68];
  let t25;
  $[69] !== boxProps || $[70] !== children ? (t25 = children && (0, import_jsx_runtime.jsx)(Box2, { as: "span", ...boxProps, children }), $[69] = boxProps, $[70] = children, $[71] = t25) : t25 = $[71];
  let t26;
  return $[72] !== mode || $[73] !== radius || $[74] !== ref2 || $[75] !== restProps || $[76] !== t20 || $[77] !== t21 || $[78] !== t22 || $[79] !== t23 || $[80] !== t24 || $[81] !== t25 || $[82] !== tone || $[83] !== type || $[84] !== width ? (t26 = (0, import_jsx_runtime.jsxs)(StyledButton, { "data-ui": "Button", ...restProps, $mode: mode, $radius: radius, $tone: tone, "data-disabled": t20, "data-selected": t21, disabled: t22, ref: ref2, type, $width: width, children: [
    t23,
    t24,
    t25
  ] }), $[72] = mode, $[73] = radius, $[74] = ref2, $[75] = restProps, $[76] = t20, $[77] = t21, $[78] = t22, $[79] = t23, $[80] = t24, $[81] = t25, $[82] = tone, $[83] = type, $[84] = width, $[85] = t26) : t26 = $[85], t26;
});
Button2.displayName = "ForwardRef(Button)";
...
function cardColorStyle(props) {
  ...
  return lt`
    ...
    ${(_a = style2 == null ? void 0 : style2.card) == null ? void 0 : _a.root}
  `;
}
var StyledCard = dt(Box2).withConfig({
  displayName: "StyledCard",
  componentId: "sc-osnro2-0"
})(responsiveBorderStyle, responsiveRadiusStyle, responsiveShadowStyle, cardStyle);
var Card2 = (0, import_react.forwardRef)(function(props, ref2) {
...
Card2.displayName = "ForwardRef(Card)";
...
function useCustomValidity(ref2, customValidity) {
  const $ = (0, import_react_compiler_runtime.c)(4);
  let t0, t1;
  $[0] !== customValidity || $[1] !== ref2 ? (t0 = () => {
    var _a;
    (_a = ref2.current) == null ? void 0 : _a.setCustomValidity(customValidity || "");
  }, t1 = [customValidity, ref2], $[0] = customValidity, $[1] = ref2, $[2] = t0, $[3] = t1) : (t0 = $[2], t1 = $[3]), (0, import_react.useEffect)(t0, t1);
}
...
var Checkbox = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  $[0] !== props ? ({
    ...
    style: style2,
    ...restProps
  } = props, $[0] = props, $[1] = checked, $[2] = className, $[3] = customValidity, $[4] = disabled, $[5] = indeterminate, $[6] = readOnly, $[7] = restProps, $[8] = style2) : (checked = $[1], className = $[2], customValidity = $[3], disabled = $[4], indeterminate = $[5], readOnly = $[6], restProps = $[7], style2 = $[8]);
  const ref2 = (0, import_react.useRef)(null);
  let t0;
  $[9] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref2.current, $[9] = t0) : t0 = $[9], (0, import_react.useImperativeHandle)(forwardedRef, t0);
  let t1, t2;
  $[10] !== indeterminate ? (t1 = () => {
    ref2.current && (ref2.current.indeterminate = indeterminate || false);
  }, t2 = [indeterminate], $[10] = indeterminate, $[11] = t1, $[12] = t2) : (t1 = $[11], t2 = $[12]), (0, import_react.useEffect)(t1, t2), useCustomValidity(ref2, customValidity);
  const t3 = !disabled && readOnly ? "" : void 0, t4 = customValidity ? "" : void 0, t5 = disabled || readOnly;
  let t6;
  $[13] !== checked || $[14] !== readOnly || $[15] !== restProps || $[16] !== t3 || $[17] !== t4 || $[18] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Input$5, { "data-read-only": t3, "data-error": t4, ...restProps, checked, disabled: t5, type: "checkbox", readOnly, ref: ref2 }), $[13] = checked, $[14] = readOnly, $[15] = restProps, $[16] = t3, $[17] = t4, $[18] = t5, $[19] = t6) : t6 = $[19];
  let t7;
  ...
  let t8;
  return $[21] !== className || $[22] !== style2 || $[23] !== t6 ? (t8 = (0, import_jsx_runtime.jsxs)(StyledCheckbox, { className, "data-ui": "Checkbox", style: style2, children: [
    t6,
    t7
  ] }), $[21] = className, $[22] = style2, $[23] = t6, $[24] = t8) : t8 = $[24], t8;
});
...
var LazyRefractor = (0, import_react.lazy)(() => import("./refractor-QQMCQEID.js"));
var StyledCode = dt.pre.withConfig({
  displayName: "StyledCode",
  componentId: "sc-4dymyn-0"
})(codeBaseStyle, responsiveCodeFontStyle);
var Code = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t5;
  return $[16] !== ref2 || $[17] !== restProps || $[18] !== t1 || $[19] !== t4 || $[20] !== weight ? (t5 = (0, import_jsx_runtime.jsx)(StyledCode, { "data-ui": "Code", ...restProps, $size: t1, $weight: weight, ref: ref2, children: t4 }), $[16] = ref2, $[17] = restProps, $[18] = t1, $[19] = t4, $[20] = weight, $[21] = t5) : t5 = $[21], t5;
});
...
var StyledContainer = dt(Box2).withConfig({
  displayName: "StyledContainer",
  componentId: "sc-wyroop-0"
})(containerBaseStyle, responsiveContainerWidthStyle);
var Container2 = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t2;
  return $[6] !== as || $[7] !== ref2 || $[8] !== restProps || $[9] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(StyledContainer, { "data-ui": "Container", ...restProps, $width: t1, forwardedAs: as, ref: ref2 }), $[6] = as, $[7] = ref2, $[8] = restProps, $[9] = t1, $[10] = t2) : t2 = $[10], t2;
});
Container2.displayName = "ForwardRef(Container)";
var StyledGrid = dt(Box2).withConfig({
  displayName: "StyledGrid",
  componentId: "sc-v8t8oz-0"
})(responsiveGridStyle);
var Grid = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t9;
  return $[28] !== as || $[29] !== children || $[30] !== ref2 || $[31] !== restProps || $[32] !== t0 || $[33] !== t1 || $[34] !== t2 || $[35] !== t3 || $[36] !== t4 || $[37] !== t5 || $[38] !== t6 || $[39] !== t7 || $[40] !== t8 ? (t9 = (0, import_jsx_runtime.jsx)(StyledGrid, { "data-as": t0, "data-ui": "Grid", ...restProps, $autoRows: t1, $autoCols: t2, $autoFlow: t3, $columns: t4, $gap: t5, $gapX: t6, $gapY: t7, $rows: t8, forwardedAs: as, ref: ref2, children }), $[28] = as, $[29] = children, $[30] = ref2, $[31] = restProps, $[32] = t0, $[33] = t1, $[34] = t2, $[35] = t3, $[36] = t4, $[37] = t5, $[38] = t6, $[39] = t7, $[40] = t8, $[41] = t9) : t9 = $[41], t9;
});
...
var Heading = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(26);
  let align, childrenProp, restProps, t0, t1, t2, textOverflow, weight;
  $[0] !== props ? ({
    accent: t0,
  ...
  $[15] !== children ? (t5 = (0, import_jsx_runtime.jsx)("span", { children }), $[15] = children, $[16] = t5) : t5 = $[16];
  let t6;
  return $[17] !== accent || $[18] !== muted || $[19] !== ref2 || $[20] !== restProps || $[21] !== t3 || $[22] !== t4 || $[23] !== t5 || $[24] !== weight ? (t6 = (0, import_jsx_runtime.jsx)(StyledHeading, { "data-ui": "Heading", ...restProps, $accent: accent, $align: t3, $muted: muted, $size: t4, $weight: weight, ref: ref2, children: t5 }), $[17] = accent, $[18] = muted, $[19] = ref2, $[20] = restProps, $[21] = t3, $[22] = t4, $[23] = t5, $[24] = weight, $[25] = t6) : t6 = $[25], t6;
});
...
var StyledInline = dt(Box2).withConfig({
  displayName: "StyledInline",
  componentId: "sc-1pkiy6j-0"
})(inlineBaseStyle, inlineSpaceStyle);
var Inline = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(15);
  let as, childrenProp, restProps, space2;
  $[0] !== props ? ({
    as,
    children: childrenProp,
    space: space2,
    ...restProps
  } = props, $[0] = props, $[1] = as, $[2] = childrenProp, $[3] = restProps, $[4] = space2) : (as = $[1], childrenProp = $[2], restProps = $[3], space2 = $[4]);
  let t0;
  $[5] !== childrenProp ? (t0 = import_react.Children.map(childrenProp, _temp$5), $[5] = childrenProp, $[6] = t0) : t0 = $[6];
  const children = t0;
  let t1;
  $[7] !== space2 ? (t1 = _getArrayProp(space2), $[7] = space2, $[8] = t1) : t1 = $[8];
  const t2 = ref2;
  let t3;
...
var KBD = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t4;
  $[8] !== children || $[9] !== fontSize2 ? (t4 = (0, import_jsx_runtime.jsx)(Text2, { as: "span", size: fontSize2, weight: "semibold", children }), $[8] = children, $[9] = fontSize2, $[10] = t4) : t4 = $[10];
  let t5;
  $[11] !== padding || $[12] !== t4 ? (t5 = (0, import_jsx_runtime.jsx)(Box2, { as: "span", padding, children: t4 }), $[11] = padding, $[12] = t4, $[13] = t5) : t5 = $[13];
  let t6;
  return $[14] !== ref2 || $[15] !== restProps || $[16] !== t3 || $[17] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(StyledKBD, { "data-ui": "KBD", ...restProps, $radius: t3, ref: ref2, children: t5 }), $[14] = ref2, $[15] = restProps, $[16] = t3, $[17] = t5, $[18] = t6) : t6 = $[18], t6;
});
...
var Arrow = (0, import_react.forwardRef)(function(props, ref2) {
  ...
  let t3;
  $[10] !== strokeWidth || $[11] !== w ? (t3 = (0, import_jsx_runtime.jsx)("mask", { id: "stroke-mask", children: (0, import_jsx_runtime.jsx)("rect", { x: 0, y: strokeWidth, width: w, height: w, fill: "white" }) }), $[10] = strokeWidth, $[11] = w, $[12] = t3) : t3 = $[12];
  const t4 = strokeWidth * 2;
  let t5;
  $[13] !== strokePath || $[14] !== t4 ? (t5 = (0, import_jsx_runtime.jsx)(StrokePath, { d: strokePath, mask: "url(#stroke-mask)", strokeWidth: t4 }), $[13] = strokePath, $[14] = t4, $[15] = t5) : t5 = $[15];
  let t6;
  $[16] !== fillPath ? (t6 = (0, import_jsx_runtime.jsx)(ShapePath, { d: fillPath }), $[16] = fillPath, $[17] = t6) : t6 = $[17];
  let t7;
  $[18] !== t2 || $[19] !== t3 || $[20] !== t5 || $[21] !== t6 || $[22] !== w ? (t7 = (0, import_jsx_runtime.jsxs)("svg", { width: w, height: w, viewBox: t2, children: [
    t3,
    t5,
    t6
  ] }), $[18] = t2, $[19] = t3, $[20] = t5, $[21] = t6, $[22] = w, $[23] = t7) : t7 = $[23];
  let t8;
  return $[24] !== ref2 || $[25] !== restProps || $[26] !== t7 || $[27] !== w ? (t8 = (0, import_jsx_runtime.jsx)(StyledArrow, { ...restProps, $w: w, ref: ref2, children: t7 }), $[24] = ref2, $[25] = restProps, $[26] = t7, $[27] = w, $[28] = t8) : t8 = $[28], t8;
});
...
var LayerChildren = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  const style2 = t0 === void 0 ? EMPTY_RECORD : t0, {
    zIndex,
    isTopLayer
  } = useLayer(), lastFocusedRef = (0, import_react.useRef)(null), ref2 = (0, import_react.useRef)(null), isTopLayerRef = (0, import_react.useRef)(isTopLayer);
  let t1;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => ref2.current, $[6] = t1) : t1 = $[6], (0, import_react.useImperativeHandle)(forwardedRef, t1);
  let t2, t3;
  ...
  $[11] !== isTopLayer || $[12] !== onFocus ? (t4 = (event) => {
    ...
    const rootElement = ref2.current, target = document.activeElement;
    !isTopLayer || !rootElement || !target || isHTMLElement(target) && containsOrEqualsElement(rootElement, target) && (lastFocusedRef.current = target);
  }, $[11] = isTopLayer, $[12] = onFocus, $[13] = t4) : t4 = $[13];
  const handleFocus = t4;
  let t5;
  $[14] !== style2 || $[15] !== zIndex ? (t5 = {
    ...style2,
    zIndex
  }, $[14] = style2, $[15] = zIndex, $[16] = t5) : t5 = $[16];
  let t6;
  return $[17] !== children || $[18] !== handleFocus || $[19] !== restProps || $[20] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(StyledLayer, { ...restProps, "data-ui": "Layer", onFocus: handleFocus, ref: ref2, style: t5, children }), $[17] = children, $[18] = handleFocus, $[19] = restProps, $[20] = t5, $[21] = t6) : t6 = $[21], t6;
});
var Layer = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(11);
  ...
  let t1;
  $[4] !== children || $[5] !== ref2 || $[6] !== restProps ? (t1 = (0, import_jsx_runtime.jsx)(LayerChildren, { ...restProps, ref: ref2, children }), $[4] = children, $[5] = ref2, $[6] = restProps, $[7] = t1) : t1 = $[7];
  let t2;
...
var SrOnly = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(4), {
    as,
    children
  } = props;
  let t0;
  return $[0] !== as || $[1] !== children || $[2] !== ref2 ? (t0 = (0, import_jsx_runtime.jsx)(StyledSrOnly, { "aria-hidden": true, as, "data-ui": "SrOnly", ref: ref2, children }), $[0] = as, $[1] = children, $[2] = ref2, $[3] = t0) : t0 = $[3], t0;
});
...
var VirtualList = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  const items = t3, {
    space: space2
  } = useTheme_v2(), ref2 = (0, import_react.useRef)(null), wrapperRef = (0, import_react.useRef)(null), [scrollTop, setScrollTop] = (0, import_react.useState)(0), [scrollHeight, setScrollHeight] = (0, import_react.useState)(0), [itemHeight, setItemHeight] = (0, import_react.useState)(-1);
  let t4;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref2.current, $[10] = t4) : t4 = $[10], (0, import_react.useImperativeHandle)(forwardedRef, t4);
  let t5;
  ...
  $[14] === Symbol.for("react.memo_cache_sentinel") ? (t7 = () => {
    if (!ref2.current)
      return;
    const scrollEl = findScrollable(ref2.current.parentNode);
    if (scrollEl) {
  ...
  const len = items.length, height = itemHeight ? len * (itemHeight + space2[gap]) - space2[gap] : 0, fromIndex = height ? Math.max(Math.floor(scrollTop / height * len) - 2, 0) : 0, toIndex = height ? Math.ceil((scrollTop + scrollHeight) / height * len) + 1 : 0;
  let t10, t9;
  $[16] !== fromIndex || $[17] !== gap || $[18] !== itemHeight || $[19] !== onChange || $[20] !== scrollHeight || $[21] !== scrollTop || $[22] !== space2 || $[23] !== toIndex ? (t9 = () => {
    onChange && onChange({
      fromIndex,
      gap: space2[gap],
      itemHeight,
  ...
  }, t10 = [fromIndex, gap, itemHeight, onChange, scrollHeight, scrollTop, space2, toIndex], $[16] = fromIndex, $[17] = gap, $[18] = itemHeight, $[19] = onChange, $[20] = scrollHeight, $[21] = scrollTop, $[22] = space2, $[23] = toIndex, $[24] = t10, $[25] = t9) : (t10 = $[24], t9 = $[25]), (0, import_react.useEffect)(t9, t10);
  let t11;
  $[26] !== fromIndex || $[27] !== gap || $[28] !== getItemKey || $[29] !== itemHeight || $[30] !== items || $[31] !== renderItem || $[32] !== space2 || $[33] !== toIndex ? (t11 = {
    fromIndex,
    gap,
    itemHeight,
    space: space2,
    ...
    items,
    renderItem
  }, $[26] = fromIndex, $[27] = gap, $[28] = getItemKey, $[29] = itemHeight, $[30] = items, $[31] = renderItem, $[32] = space2, $[33] = toIndex, $[34] = t11) : t11 = $[34];
  ...
  let t14;
  return $[40] !== as || $[41] !== restProps || $[42] !== t13 ? (t14 = (0, import_jsx_runtime.jsx)(StyledVirtualList, { as, "data-ui": "VirtualList", ...restProps, ref: ref2, children: t13 }), $[40] = as, $[41] = restProps, $[42] = t13, $[43] = t14) : t14 = $[43], t14;
});
...
function useChildren(t0) {
  ...
  let t1;
  if ($[5] !== fromIndex || $[6] !== gap || $[7] !== getItemKey || $[8] !== itemHeight || $[9] !== items || $[10] !== renderItem || $[11] !== space2 || $[12] !== toIndex) {
    let t2;
    $[14] !== fromIndex || $[15] !== gap || $[16] !== getItemKey || $[17] !== itemHeight || $[18] !== renderItem || $[19] !== space2 ? (t2 = (item, _itemIndex) => {
      ...
      return (0, import_jsx_runtime.jsx)(ItemWrapper, { style: {
        top: itemIndex * (itemHeight + space2[gap])
      }, children: node2 }, key2);
    }, $[14] = fromIndex, $[15] = gap, $[16] = getItemKey, $[17] = itemHeight, $[18] = renderItem, $[19] = space2, $[20] = t2) : t2 = $[20], t1 = items.slice(fromIndex, toIndex).map(t2), $[5] = fromIndex, $[6] = gap, $[7] = getItemKey, $[8] = itemHeight, $[9] = items, $[10] = renderItem, $[11] = space2, $[12] = toIndex, $[13] = t1;
  } else
    t1 = $[13];
  return t1;
}
...
var MotionCard$1 = dt(motion.create(Card2)).withConfig({
...
var MotionFlex = dt(motion.create(Flex2)).withConfig({
  displayName: "MotionFlex",
  componentId: "sc-ihg31s-1"
})`will-change:opacity;`;
var PopoverCard = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(66);
  let animate, arrow2, arrowRef, arrowX, arrowY, children, marginsProp, originX, originY, overflow, padding, placement, radius, restProps, scheme, shadow, strategy, style2, tone, width, xProp, yProp;
  $[0] !== props ? ({
    ...
    y: yProp,
    ...restProps
  } = props, $[0] = props, $[1] = animate, $[2] = arrow2, $[3] = arrowRef, $[4] = arrowX, $[5] = arrowY, $[6] = children, $[7] = marginsProp, $[8] = originX, $[9] = originY, $[10] = overflow, $[11] = padding, $[12] = placement, $[13] = radius, $[14] = restProps, $[15] = scheme, $[16] = shadow, $[17] = strategy, $[18] = style2, $[19] = tone, $[20] = width, $[21] = xProp, $[22] = yProp) : (animate = $[1], arrow2 = $[2], arrowRef = $[3], arrowX = $[4], arrowY = $[5], children = $[6], marginsProp = $[7], originX = $[8], originY = $[9], overflow = $[10], padding = $[11], placement = $[12], radius = $[13], restProps = $[14], scheme = $[15], shadow = $[16], strategy = $[17], style2 = $[18], tone = $[19], width = $[20], xProp = $[21], yProp = $[22]);
  const {
    zIndex
  } = useLayer(), margins = marginsProp || DEFAULT_POPOVER_MARGINS, x = (xProp ?? 0) + margins[3], y = (yProp ?? 0) + margins[0], t0 = animate ? "transform" : void 0;
  let t1;
  $[23] !== originX || $[24] !== originY || $[25] !== strategy || $[26] !== style2 || $[27] !== t0 || $[28] !== width || $[29] !== x || $[30] !== y || $[31] !== zIndex ? (t1 = {
    left: x,
    originX,
    originY,
    position: strategy,
    ...
    willChange: t0,
    ...style2
  }, $[23] = originX, $[24] = originY, $[25] = strategy, $[26] = style2, $[27] = t0, $[28] = width, $[29] = x, $[30] = y, $[31] = zIndex, $[32] = t1) : t1 = $[32];
  ...
  let t9;
  $[42] !== children || $[43] !== padding ? (t9 = (0, import_jsx_runtime.jsx)(Flex2, { direction: "column", flex: 1, padding, children }), $[42] = children, $[43] = padding, $[44] = t9) : t9 = $[44];
  let t10;
  ...
  let t12;
  return $[52] !== placement || $[53] !== radius || $[54] !== ref2 || $[55] !== rootStyle2 || $[56] !== scheme || $[57] !== shadow || $[58] !== t10 || $[59] !== t11 || $[60] !== t5 || $[61] !== t6 || $[62] !== t7 || $[63] !== t8 || $[64] !== tone ? (t12 = (0, import_jsx_runtime.jsxs)(MotionCard$1, { "data-ui": "Popover", ...t5, "data-placement": placement, radius, ref: ref2, scheme, shadow, sizing: "border", style: rootStyle2, tone, variants: POPOVER_MOTION_PROPS.card, transition: POPOVER_MOTION_PROPS.transition, initial: t6, animate: t7, exit: t8, children: [
    t10,
    t11
  ] }), $[52] = placement, $[53] = radius, $[54] = ref2, $[55] = rootStyle2, $[56] = scheme, $[57] = shadow, $[58] = t10, $[59] = t11, $[60] = t5, $[61] = t6, $[62] = t7, $[63] = t8, $[64] = tone, $[65] = t12) : t12 = $[65], t12;
});
...
var Popover = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  const zOffset = t15, ref2 = (0, import_react.useRef)(null), arrowRef = (0, import_react.useRef)(null);
  let t16;
  $[38] === Symbol.for("react.memo_cache_sentinel") ? (t16 = () => ref2.current, $[38] = t16) : t16 = $[38], (0, import_react.useImperativeHandle)(forwardedRef, t16);
  ...
  $[48] !== matchReferenceWidth || $[49] !== maxWidth || $[50] !== open || $[51] !== width ? (t22 = () => {
    const floatingElement = ref2.current;
  ...
  let t28;
  $[73] !== refs ? (t28 = (node2) => {
    ref2.current = node2, refs.setFloating(node2);
  ...
  const child = t31;
  let t32, t33;
  if ($[82] !== update2 ? (t32 = () => update2, t33 = [update2], $[82] = update2, $[83] = t32, $[84] = t33) : (t32 = $[83], t33 = $[84]), (0, import_react.useImperativeHandle)(updateRef, t32, t33), disabled) {
    let t342;
...
var Radio = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  $[0] !== props ? ({
    ...
    readOnly,
    ...restProps
  } = props, $[0] = props, $[1] = className, $[2] = customValidity, $[3] = disabled, $[4] = readOnly, $[5] = restProps, $[6] = style2) : (className = $[1], customValidity = $[2], disabled = $[3], readOnly = $[4], restProps = $[5], style2 = $[6]);
  const ref2 = (0, import_react.useRef)(null);
  let t0;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref2.current, $[7] = t0) : t0 = $[7], (0, import_react.useImperativeHandle)(forwardedRef, t0), useCustomValidity(ref2, customValidity);
  const t1 = !disabled && readOnly ? "" : void 0, t2 = customValidity ? "" : void 0, t3 = disabled || readOnly;
  let t4;
  $[8] !== readOnly || $[9] !== restProps || $[10] !== t1 || $[11] !== t2 || $[12] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(Input$4, { "data-read-only": t1, "data-error": t2, ...restProps, disabled: t3, readOnly, ref: ref2, type: "radio" }), $[8] = readOnly, $[9] = restProps, $[10] = t1, $[11] = t2, $[12] = t3, $[13] = t4) : t4 = $[13];
  let t5;
  $[14] === Symbol.for("react.memo_cache_sentinel") ? (t5 = (0, import_jsx_runtime.jsx)("span", {}), $[14] = t5) : t5 = $[14];
  let t6;
  return $[15] !== className || $[16] !== style2 || $[17] !== t4 ? (t6 = (0, import_jsx_runtime.jsxs)(StyledRadio, { className, "data-ui": "Radio", style: style2, children: [
    t4,
    t5
  ] }), $[15] = className, $[16] = style2, $[17] = t4, $[18] = t6) : t6 = $[18], t6;
});
...
var IconBox = dt(Box2).withConfig({
  displayName: "IconBox",
...
var Select = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  const fontSize2 = t0 === void 0 ? 2 : t0, padding = t1 === void 0 ? 3 : t1, radius = t2 === void 0 ? 2 : t2, space2 = t3 === void 0 ? 3 : t3, ref2 = (0, import_react.useRef)(null);
  let t4;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref2.current, $[10] = t4) : t4 = $[10], (0, import_react.useImperativeHandle)(forwardedRef, t4), useCustomValidity(ref2, customValidity);
  ...
  let t9;
  $[17] !== space2 ? (t9 = _getArrayProp(space2), $[17] = space2, $[18] = t9) : t9 = $[18];
  const t10 = disabled || readOnly;
  let t11;
  $[19] !== children || $[20] !== restProps || $[21] !== t10 || $[22] !== t5 || $[23] !== t6 || $[24] !== t7 || $[25] !== t8 || $[26] !== t9 ? (t11 = (0, import_jsx_runtime.jsx)(Input$3, { "data-read-only": t5, "data-ui": "Select", ...restProps, $fontSize: t6, $padding: t7, $radius: t8, $space: t9, disabled: t10, ref: ref2, children }), $[19] = children, $[20] = restProps, $[21] = t10, $[22] = t5, $[23] = t6, $[24] = t7, $[25] = t8, $[26] = t9, $[27] = t11) : t11 = $[27];
  let t12;
  $[28] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime.jsx)(ChevronDownIcon, {}), $[28] = t12) : t12 = $[28];
  let t13;
  $[29] !== fontSize2 ? (t13 = (0, import_jsx_runtime.jsx)(Text2, { size: fontSize2, children: t12 }), $[29] = fontSize2, $[30] = t13) : t13 = $[30];
  let t14;
...
var StyledStack = dt(Box2).withConfig({
  displayName: "StyledStack",
  componentId: "sc-8dpfq2-0"
})(stackBaseStyle, responsiveStackSpaceStyle);
var Stack2 = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(12);
  let as, restProps, space2;
  $[0] !== props ? ({
    as,
    space: space2,
    ...restProps
  } = props, $[0] = props, $[1] = as, $[2] = restProps, $[3] = space2) : (as = $[1], restProps = $[2], space2 = $[3]);
  const t0 = typeof as == "string" ? as : void 0;
  let t1;
  $[4] !== space2 ? (t1 = _getArrayProp(space2), $[4] = space2, $[5] = t1) : t1 = $[5];
  let t2;
  return $[6] !== as || $[7] !== ref2 || $[8] !== restProps || $[9] !== t0 || $[10] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(StyledStack, { "data-as": t0, "data-ui": "Stack", ...restProps, $space: t1, forwardedAs: as, ref: ref2 }), $[6] = as, $[7] = ref2, $[8] = restProps, $[9] = t0, $[10] = t1, $[11] = t2) : t2 = $[11], t2;
});
Stack2.displayName = "ForwardRef(Stack)";
...
var Switch = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  $[0] !== props ? ({
    ...
    style: style2,
    ...restProps
  } = props, $[0] = props, $[1] = checked, $[2] = className, $[3] = disabled, $[4] = indeterminate, $[5] = readOnly, $[6] = restProps, $[7] = style2) : (checked = $[1], className = $[2], disabled = $[3], indeterminate = $[4], readOnly = $[5], restProps = $[6], style2 = $[7]);
  const ref2 = (0, import_react.useRef)(null);
  let t0;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref2.current, $[8] = t0) : t0 = $[8], (0, import_react.useImperativeHandle)(forwardedRef, t0);
  let t1, t2;
  $[9] !== indeterminate ? (t1 = () => {
    ref2.current && (ref2.current.indeterminate = indeterminate || false);
  ...
  let t6;
  $[12] !== restProps || $[13] !== t3 || $[14] !== t4 || $[15] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Input$2, { "data-read-only": t3, ...restProps, checked: t4, disabled: t5, type: "checkbox", ref: ref2 }), $[12] = restProps, $[13] = t3, $[14] = t4, $[15] = t5, $[16] = t6) : t6 = $[16];
  let t7;
  ...
  let t9;
  return $[21] !== className || $[22] !== style2 || $[23] !== t6 || $[24] !== t8 ? (t9 = (0, import_jsx_runtime.jsxs)(StyledSwitch, { className, "data-ui": "Switch", style: style2, children: [
    t6,
    t8
  ] }), $[21] = className, $[22] = style2, $[23] = t6, $[24] = t8, $[25] = t9) : t9 = $[25], t9;
});
...
var TextArea = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  const border2 = t0 === void 0 ? true : t0, disabled = t1 === void 0 ? false : t1, fontSize2 = t2 === void 0 ? 2 : t2, padding = t3 === void 0 ? 3 : t3, radius = t4 === void 0 ? 2 : t4, ref2 = (0, import_react.useRef)(null), rootTheme = useRootTheme();
  let t5;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t5 = () => ref2.current, $[10] = t5) : t5 = $[10], (0, import_react.useImperativeHandle)(forwardedRef, t5), useCustomValidity(ref2, customValidity);
  ...
  let t12;
  $[16] !== disabled || $[17] !== restProps || $[18] !== rootTheme.scheme || $[19] !== rootTheme.tone || $[20] !== t8 || $[21] !== t9 || $[22] !== weight ? (t12 = (0, import_jsx_runtime.jsx)(Input$1, { "data-as": "textarea", "data-scheme": t6, "data-tone": t7, ...restProps, $fontSize: t8, $padding: t9, $scheme: t10, $space: t11, $tone: rootTheme.tone, $weight: weight, disabled, ref: ref2 }), $[16] = disabled, $[17] = restProps, $[18] = rootTheme.scheme, $[19] = rootTheme.tone, $[20] = t8, $[21] = t9, $[22] = weight, $[23] = t12) : t12 = $[23];
  let t13;
...
var StyledTextInput = dt(Card2).attrs({
  forwardedAs: "span"
}).withConfig({
...
var TextInput = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  let IconComponent, IconRightComponent, __unstable_disableFocusRing, clearButton, customValidity, onClear, prefix3, readOnly, restProps, suffix2, t0, t1, t2, t3, t4, t5, t6, weight;
  $[0] !== props ? ({
    __unstable_disableFocusRing,
    border: t0,
    clearButton,
    ...
    weight,
    ...restProps
  } = props, $[0] = props, $[1] = IconComponent, $[2] = IconRightComponent, $[3] = __unstable_disableFocusRing, $[4] = clearButton, $[5] = customValidity, $[6] = onClear, $[7] = prefix3, $[8] = readOnly, $[9] = restProps, $[10] = suffix2, $[11] = t0, $[12] = t1, $[13] = t2, $[14] = t3, $[15] = t4, $[16] = t5, $[17] = t6, $[18] = weight) : (IconComponent = $[1], IconRightComponent = $[2], __unstable_disableFocusRing = $[3], clearButton = $[4], customValidity = $[5], onClear = $[6], prefix3 = $[7], readOnly = $[8], restProps = $[9], suffix2 = $[10], t0 = $[11], t1 = $[12], t2 = $[13], t3 = $[14], t4 = $[15], t5 = $[16], t6 = $[17], weight = $[18]);
  const border2 = t0 === void 0 ? true : t0, disabled = t1 === void 0 ? false : t1, fontSizeProp = t2 === void 0 ? 2 : t2, paddingProp = t3 === void 0 ? 3 : t3, radiusProp = t4 === void 0 ? 2 : t4, spaceProp = t5 === void 0 ? 3 : t5, type = t6 === void 0 ? "text" : t6, ref2 = (0, import_react.useRef)(null), rootTheme = useRootTheme();
  let t7;
  ...
  const space2 = t10, $hasClearButton = !!clearButton, $hasIcon = !!IconComponent, $hasIconRight = !!IconRightComponent, $hasSuffix = !!suffix2, $hasPrefix = !!prefix3;
  let t11;
  $[27] === Symbol.for("react.memo_cache_sentinel") ? (t11 = () => ref2.current, $[27] = t11) : t11 = $[27], (0, import_react.useImperativeHandle)(forwardedRef, t11), useCustomValidity(ref2, customValidity);
  const handleClearMouseDown = _temp$2;
  let t12;
  $[28] !== onClear ? (t12 = (event_0) => {
    var _a;
    event_0.preventDefault(), event_0.stopPropagation(), onClear && onClear(), (_a = ref2.current) == null ? void 0 : _a.focus();
  }, $[28] = onClear, $[29] = t12) : t12 = $[29];
  const handleClearClick = t12;
  let t13;
  $[30] !== prefix3 || $[31] !== radius ? (t13 = prefix3 && (0, import_jsx_runtime.jsx)(Prefix, { borderTop: true, borderLeft: true, borderBottom: true, radius, sizing: "border", tone: "inherit", children: (0, import_jsx_runtime.jsx)("span", { children: prefix3 }) }), $[30] = prefix3, $[31] = radius, $[32] = t13) : t13 = $[32];
  const prefixNode = t13, t14 = border2 ? "" : void 0;
  let t15;
  $[33] !== IconComponent || $[34] !== fontSize2 || $[35] !== padding ? (t15 = IconComponent && (0, import_jsx_runtime.jsx)(LeftBox, { padding, children: (0, import_jsx_runtime.jsxs)(Text2, { size: fontSize2, children: [
    (0, import_react.isValidElement)(IconComponent) && IconComponent,
    (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime.jsx)(IconComponent, {})
  ] }) }), $[33] = IconComponent, $[34] = fontSize2, $[35] = padding, $[36] = t15) : t15 = $[36];
  let t16;
  $[37] !== $hasClearButton || $[38] !== IconRightComponent || $[39] !== fontSize2 || $[40] !== padding ? (t16 = !$hasClearButton && IconRightComponent && (0, import_jsx_runtime.jsx)(RightBox, { padding, children: (0, import_jsx_runtime.jsxs)(Text2, { size: fontSize2, children: [
    (0, import_react.isValidElement)(IconRightComponent) && IconRightComponent,
    (0, import_react_is.isValidElementType)(IconRightComponent) && (0, import_jsx_runtime.jsx)(IconRightComponent, {})
  ...
  let t21;
  $[67] !== radius || $[68] !== suffix2 ? (t21 = suffix2 && (0, import_jsx_runtime.jsx)(Suffix, { borderTop: true, borderRight: true, borderBottom: true, radius, sizing: "border", tone: "inherit", children: (0, import_jsx_runtime.jsx)("span", { children: suffix2 }) }), $[67] = radius, $[68] = suffix2, $[69] = t21) : t21 = $[69];
  const suffixNode = t21, t22 = $hasIconRight || $hasClearButton;
  let t23;
  $[70] !== $hasIcon || $[71] !== disabled || $[72] !== fontSize2 || $[73] !== padding || $[74] !== readOnly || $[75] !== restProps || $[76] !== rootTheme.scheme || $[77] !== rootTheme.tone || $[78] !== space2 || $[79] !== t22 || $[80] !== type || $[81] !== weight ? (t23 = (0, import_jsx_runtime.jsx)(Input, { "data-as": "input", "data-scheme": rootTheme.scheme, "data-tone": rootTheme.tone, ...restProps, $fontSize: fontSize2, $iconLeft: $hasIcon, $iconRight: t22, $padding: padding, $scheme: rootTheme.scheme, $space: space2, $tone: rootTheme.tone, $weight: weight, disabled, readOnly, ref: ref2, type }), $[70] = $hasIcon, $[71] = disabled, $[72] = fontSize2, $[73] = padding, $[74] = readOnly, $[75] = restProps, $[76] = rootTheme.scheme, $[77] = rootTheme.tone, $[78] = space2, $[79] = t22, $[80] = type, $[81] = weight, $[82] = t23) : t23 = $[82];
  let t24;
...
var MotionCard = dt(motion.create(Card2)).withConfig({
  displayName: "MotionCard",
  componentId: "sc-1xn138w-0"
})`will-change:transform;`;
var TooltipCard = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(48);
  let animate, arrow2, arrowRef, arrowX, arrowY, children, originX, originY, padding, placement, radius, restProps, scheme, shadow, style2;
  $[0] !== props ? ({
    animate,
    arrow: arrow2,
    arrowRef,
    ...
    style: style2,
    ...restProps
  } = props, $[0] = props, $[1] = animate, $[2] = arrow2, $[3] = arrowRef, $[4] = arrowX, $[5] = arrowY, $[6] = children, $[7] = originX, $[8] = originY, $[9] = padding, $[10] = placement, $[11] = radius, $[12] = restProps, $[13] = scheme, $[14] = shadow, $[15] = style2) : (animate = $[1], arrow2 = $[2], arrowRef = $[3], arrowX = $[4], arrowY = $[5], children = $[6], originX = $[7], originY = $[8], padding = $[9], placement = $[10], radius = $[11], restProps = $[12], scheme = $[13], shadow = $[14], style2 = $[15]);
  const t0 = animate ? "transform" : void 0;
  let t1;
  $[16] !== originX || $[17] !== originY || $[18] !== style2 || $[19] !== t0 ? (t1 = {
    originX,
    originY,
    willChange: t0,
    ...style2
  }, $[16] = originX, $[17] = originY, $[18] = style2, $[19] = t0, $[20] = t1) : t1 = $[20];
  const rootStyle2 = t1, t2 = arrowX !== null ? arrowX : void 0, t3 = arrowY !== null ? arrowY : void 0;
  let t4;
  $[21] !== t2 || $[22] !== t3 ? (t4 = {
    left: t2,
  ...
  let t10;
  return $[34] !== children || $[35] !== padding || $[36] !== placement || $[37] !== radius || $[38] !== ref2 || $[39] !== rootStyle2 || $[40] !== scheme || $[41] !== shadow || $[42] !== t5 || $[43] !== t6 || $[44] !== t7 || $[45] !== t8 || $[46] !== t9 ? (t10 = (0, import_jsx_runtime.jsxs)(MotionCard, { "data-ui": "Tooltip__card", ...t5, "data-placement": placement, padding, radius, ref: ref2, scheme, shadow, style: rootStyle2, variants: POPOVER_MOTION_PROPS.card, transition: POPOVER_MOTION_PROPS.transition, initial: t6, animate: t7, exit: t8, children: [
    children,
    t9
  ] }), $[34] = children, $[35] = padding, $[36] = placement, $[37] = radius, $[38] = ref2, $[39] = rootStyle2, $[40] = scheme, $[41] = shadow, $[42] = t5, $[43] = t6, $[44] = t7, $[45] = t8, $[46] = t9, $[47] = t10) : t10 = $[47], t10;
});
...
var Tooltip2 = (0, import_react.forwardRef)(function(props, forwardedRef) {
  var _a, _b, _c, _d, _e;
  ...
  const fallbackPlacements = t6, ref2 = (0, import_react.useRef)(null), [referenceElement, setReferenceElement] = (0, import_react.useState)(null), arrowRef = (0, import_react.useRef)(null), [tooltipMaxWidth, setTooltipMaxWidth] = (0, import_react.useState)(0);
  let t7;
  $[19] === Symbol.for("react.memo_cache_sentinel") ? (t7 = () => ref2.current, $[19] = t7) : t7 = $[19], (0, import_react.useImperativeHandle)(forwardedRef, t7);
  ...
  let t12;
  $[33] !== closeDelay || $[34] !== isInsideGroup || $[35] !== openDelay || $[36] !== setIsGroupActive || $[37] !== setIsOpen || $[38] !== setOpenTooltipId || $[39] !== tooltipId ? (t12 = (open, immediate2) => {
    if (isInsideGroup)
      if (open) {
        const groupedOpenDelay = immediate2 ? 0 : openDelay;
        ...
        setIsGroupActive == null ? void 0 : setIsGroupActive(open, groupDeactivateDelay), setOpenTooltipId == null ? void 0 : setOpenTooltipId(null, immediate2 ? 0 : closeDelay);
      }
    else
      setIsOpen(open, immediate2 ? 0 : open ? openDelay : closeDelay);
  ...
  let t28;
  $[84] !== update2 ? (t28 = (arrowEl) => {
    arrowRef.current = arrowEl, update2();
  }, $[84] = update2, $[85] = t28) : t28 = $[85];
  const setArrow = t28;
  let t29;
  $[86] !== refs ? (t29 = (node2) => {
    ref2.current = node2, refs.setFloating(node2);
...
Tooltip2.displayName = "ForwardRef(Tooltip)";
...
var Hotkeys = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(26);
  ...
  if ($[10] !== fontSize2 || $[11] !== keys || $[12] !== padding || $[13] !== radius) {
    ...
    t2 = $[14];
  let t3;
  $[19] !== space2 || $[20] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(Inline, { as: "span", space: space2, children: t2 }), $[19] = space2, $[20] = t2, $[21] = t3) : t3 = $[21];
  let t4;
  return $[22] !== ref2 || $[23] !== restProps || $[24] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(StyledHotkeys, { "data-ui": "Hotkeys", ...restProps, ref: ref2, children: t3 }), $[22] = ref2, $[23] = restProps, $[24] = t3, $[25] = t4) : t4 = $[25], t4;
});
...
var StyledMenu = dt(Box2).withConfig({
...
var Menu = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  const padding = t0 === void 0 ? 1 : t0, space2 = t1 === void 0 ? 1 : t1, shouldFocus = _shouldFocus ?? (props.focusFirst && "first" || props.focusLast && "last" || null), ref2 = (0, import_react.useRef)(null);
  let t2;
  $[13] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => ref2.current, $[13] = t2) : t2 = $[13], (0, import_react.useImperativeHandle)(forwardedRef, t2);
  const {
    isTopLayer
  } = useLayer();
  let t3;
  ...
  $[18] !== registerElement ? (t4 = (el) => {
    unregisterElementRef.current && (unregisterElementRef.current(), unregisterElementRef.current = null), ref2.current = el, ref2.current && registerElement && (unregisterElementRef.current = registerElement(ref2.current));
  ...
  let t7;
  $[24] === Symbol.for("react.memo_cache_sentinel") ? (t7 = () => [ref2.current], $[24] = t7) : t7 = $[24], useClickOutsideEvent(isTopLayer && onClickOutside, t7);
  let t8;
  ...
  const value = t9;
  let t10;
  $[37] !== children || $[38] !== space2 ? (t10 = (0, import_jsx_runtime.jsx)(Stack2, { space: space2, children }), $[37] = children, $[38] = space2, $[39] = t10) : t10 = $[39];
  let t11;
...
var Selectable = dt(Box2).withConfig({
...
function MenuGroup(props) {
  ...
  const as = t0 === void 0 ? "button" : t0, fontSize2 = t1 === void 0 ? 1 : t1, padding = t2 === void 0 ? 3 : t2, radius = t3 === void 0 ? 2 : t3, space2 = t4 === void 0 ? 3 : t4, tone = t5 === void 0 ? "default" : t5, menu = useMenu(), {
    scheme
  } = useRootTheme(), {
    activeElement,
    mount,
  ...
  let t26;
  $[48] !== IconComponent || $[49] !== fontSize2 ? (t26 = IconComponent && (0, import_jsx_runtime.jsxs)(Text2, { size: fontSize2, children: [
    (0, import_react.isValidElement)(IconComponent) && IconComponent,
    (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime.jsx)(IconComponent, {})
  ] }), $[48] = IconComponent, $[49] = fontSize2, $[50] = t26) : t26 = $[50];
  let t27;
  $[51] !== fontSize2 || $[52] !== text ? (t27 = (0, import_jsx_runtime.jsx)(Box2, { flex: 1, children: (0, import_jsx_runtime.jsx)(Text2, { size: fontSize2, textOverflow: "ellipsis", weight: "medium", children: text }) }), $[51] = fontSize2, $[52] = text, $[53] = t27) : t27 = $[53];
  let t28;
  $[54] === Symbol.for("react.memo_cache_sentinel") ? (t28 = (0, import_jsx_runtime.jsx)(ChevronRightIcon, {}), $[54] = t28) : t28 = $[54];
  let t29;
  $[55] !== fontSize2 ? (t29 = (0, import_jsx_runtime.jsx)(Text2, { size: fontSize2, children: t28 }), $[55] = fontSize2, $[56] = t29) : t29 = $[56];
  let t30;
  $[57] !== padding || $[58] !== space2 || $[59] !== t26 || $[60] !== t27 || $[61] !== t29 ? (t30 = (0, import_jsx_runtime.jsxs)(Flex2, { gap: space2, padding, children: [
    t26,
    t27,
    t29
  ] }), $[57] = padding, $[58] = space2, $[59] = t26, $[60] = t27, $[61] = t29, $[62] = t30) : t30 = $[62];
  let t31;
...
var MenuItem = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  const as = t0 === void 0 ? "button" : t0, fontSize2 = t1 === void 0 ? 1 : t1, padding = t2 === void 0 ? 3 : t2, radius = t3 === void 0 ? 2 : t3, space2 = t4 === void 0 ? 3 : t4, tone = t5 === void 0 ? "default" : t5, {
    scheme
  ...
  } = menu, onItemMouseEnter = _onItemMouseEnter ?? menu.onItemMouseEnter, onItemMouseLeave = _onItemMouseLeave ?? menu.onItemMouseLeave, [rootElement, setRootElement] = (0, import_react.useState)(null), active = !!activeElement && activeElement === rootElement, ref2 = (0, import_react.useRef)(null);
  let t6;
  $[23] === Symbol.for("react.memo_cache_sentinel") ? (t6 = () => ref2.current, $[23] = t6) : t6 = $[23], (0, import_react.useImperativeHandle)(forwardedRef, t6);
  let t7, t8;
  ...
  $[43] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (el) => {
    ref2.current = el, setRootElement(el);
  }, $[43] = t12) : t12 = $[43];
  ...
  let t20;
  $[47] !== IconComponent || $[48] !== IconRightComponent || $[49] !== fontSize2 || $[50] !== hotkeys || $[51] !== hotkeysFontSize || $[52] !== paddingProps || $[53] !== space2 || $[54] !== text ? (t20 = (IconComponent || text || IconRightComponent) && (0, import_jsx_runtime.jsxs)(Flex2, { as: "span", gap: space2, align: "center", ...paddingProps, children: [
    IconComponent && (0, import_jsx_runtime.jsxs)(Text2, { size: fontSize2, children: [
      (0, import_react.isValidElement)(IconComponent) && IconComponent,
      (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime.jsx)(IconComponent, {})
    ] }),
    text && (0, import_jsx_runtime.jsx)(Box2, { flex: 1, children: (0, import_jsx_runtime.jsx)(Text2, { size: fontSize2, textOverflow: "ellipsis", weight: "medium", children: text }) }),
  ...
  ] }), $[47] = IconComponent, $[48] = IconRightComponent, $[49] = fontSize2, $[50] = hotkeys, $[51] = hotkeysFontSize, $[52] = paddingProps, $[53] = space2, $[54] = text, $[55] = t20) : t20 = $[55];
  let t21;
  $[56] !== children || $[57] !== paddingProps ? (t21 = children && (0, import_jsx_runtime.jsx)(Box2, { as: "span", ...paddingProps, children }), $[56] = children, $[57] = paddingProps, $[58] = t21) : t21 = $[58];
  let t22;
...
var CustomButton = dt(Button2).withConfig({
...
var Tab = (0, import_react.forwardRef)(function(props, forwardedRef) {
  ...
  const fontSize2 = t0 === void 0 ? 1 : t0, padding = t1 === void 0 ? 2 : t1, ref2 = (0, import_react.useRef)(null), focusedRef = (0, import_react.useRef)(false);
  let t2;
  $[11] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => ref2.current, $[11] = t2) : t2 = $[11], (0, import_react.useImperativeHandle)(forwardedRef, t2);
  let t3;
...
var TabList = (0, import_react.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime.c)(15);
  ...
  let t2;
  return $[10] !== handleKeyDown || $[11] !== ref2 || $[12] !== restProps || $[13] !== tabs ? (t2 = (0, import_jsx_runtime.jsx)(CustomInline, { "data-ui": "TabList", ...restProps, onKeyDown: handleKeyDown, ref: ref2, role: "tablist", children: tabs }), $[10] = handleKeyDown, $[11] = ref2, $[12] = restProps, $[13] = tabs, $[14] = t2) : t2 = $[14], t2;
});
TabList.displayName = "ForwardRef(TabList)";

// node_modules/sanity-plugin-utils/node_modules/@sanity/ui/dist/index.mjs
...
var ListBox = dt(Box2).withConfig({
  displayName: "ListBox",
...
var InnerAutocomplete = (0, import_react3.forwardRef)(function(props, forwardedRef) {
  const $ = (0, import_react_compiler_runtime2.c)(181);
  let customValidity, disabled, filterOptionProp, icon, id, loading, onBlur, onChange, onFocus, onQueryChange, onSelect, openButton, openOnFocus, optionsProp, prefix3, readOnly, relatedElements, renderOptionProp, renderPopover, restProps, suffix2, t0, t1, t2, t3, t4, t5, t6, valueProp;
  $[0] !== props ? ({
    border: t0,
    customValidity,
    disabled,
    ...
    value: valueProp,
    ...restProps
  } = props, $[0] = props, $[1] = customValidity, $[2] = disabled, $[3] = filterOptionProp, $[4] = icon, $[5] = id, $[6] = loading, $[7] = onBlur, $[8] = onChange, $[9] = onFocus, $[10] = onQueryChange, $[11] = onSelect, $[12] = openButton, $[13] = openOnFocus, $[14] = optionsProp, $[15] = prefix3, $[16] = readOnly, $[17] = relatedElements, $[18] = renderOptionProp, $[19] = renderPopover, $[20] = restProps, $[21] = suffix2, $[22] = t0, $[23] = t1, $[24] = t2, $[25] = t3, $[26] = t4, $[27] = t5, $[28] = t6, $[29] = valueProp) : (customValidity = $[1], disabled = $[2], filterOptionProp = $[3], icon = $[4], id = $[5], loading = $[6], onBlur = $[7], onChange = $[8], onFocus = $[9], onQueryChange = $[10], onSelect = $[11], openButton = $[12], openOnFocus = $[13], optionsProp = $[14], prefix3 = $[15], readOnly = $[16], relatedElements = $[17], renderOptionProp = $[18], renderPopover = $[19], restProps = $[20], suffix2 = $[21], t0 = $[22], t1 = $[23], t2 = $[24], t3 = $[25], t4 = $[26], t5 = $[27], t6 = $[28], valueProp = $[29]);
  ...
  const [state, dispatch] = (0, import_react3.useReducer)(autocompleteReducer, t9), {
    activeValue,
    focused,
    listFocused,
    query,
  ...
  $[33] !== fontSize2 || $[34] !== paddingProp ? (t10 = (t112) => {
    ...
    return (0, import_jsx_runtime2.jsx)(Card2, { "data-as": "button", padding: paddingProp, radius: 2, tone: "inherit", children: (0, import_jsx_runtime2.jsx)(Text2, { size: fontSize2, textOverflow: "ellipsis", children: value_0 }) });
  }, $[33] = fontSize2, $[34] = paddingProp, $[35] = t10) : t10 = $[35];
  const renderOption = typeof renderOptionProp == "function" ? renderOptionProp : t10, filterOption = typeof filterOptionProp == "function" ? filterOptionProp : DEFAULT_FILTER_OPTION, rootElementRef = (0, import_react3.useRef)(null), resultsPopoverElementRef = (0, import_react3.useRef)(null), inputElementRef = (0, import_react3.useRef)(null), listBoxElementRef = (0, import_react3.useRef)(null), [inputElement, _setInputElement] = (0, import_react3.useState)(null);
  let t11;
  $[36] === Symbol.for("react.memo_cache_sentinel") ? (t11 = (node2) => {
    (0, import_react3.startTransition)(() => _setInputElement(node2));
  }, $[36] = t11) : t11 = $[36];
  const setInputElement = t11, listFocusedRef = (0, import_react3.useRef)(false), valueRef = (0, import_react3.useRef)(value), valuePropRef = (0, import_react3.useRef)(valueProp), popoverMouseWithinRef = (0, import_react3.useRef)(false);
  let t12, t13;
  $[37] !== inputElement ? (t12 = () => inputElement, t13 = [inputElement], $[37] = inputElement, $[38] = t12, $[39] = t13) : (t12 = $[38], t13 = $[39]), (0, import_react3.useImperativeHandle)(inputElementRef, t12, t13);
  let t14, t15;
  $[40] !== inputElement ? (t14 = () => inputElement, t15 = [inputElement], $[40] = inputElement, $[41] = t14, $[42] = t15) : (t14 = $[41], t15 = $[42]), (0, import_react3.useImperativeHandle)(forwardedRef, t14, t15);
  ...
  }, t30 = [valueProp], $[84] = valueProp, $[85] = t29, $[86] = t30) : (t29 = $[85], t30 = $[86]), (0, import_react3.useEffect)(t29, t30);
  let t31, t32;
  $[87] !== focused ? (t31 = () => {
  ...
  }, t32 = [focused], $[87] = focused, $[88] = t31, $[89] = t32) : (t31 = $[88], t32 = $[89]), (0, import_react3.useEffect)(t31, t32);
  let t33, t34;
  ...
  }, t34 = [activeValue, filteredOptions], $[90] = activeValue, $[91] = filteredOptions, $[92] = t33, $[93] = t34) : (t33 = $[92], t34 = $[93]), (0, import_react3.useEffect)(t33, t34);
  let t35;
  bb0: {
  ...
  let t37;
  $[98] !== disabled || $[99] !== expanded || $[100] !== fontSize2 || $[101] !== handleOpenClick || $[102] !== openButton || $[103] !== openButtonBoxPadding || $[104] !== openButtonPadding || $[105] !== openButtonProps || $[106] !== readOnly ? (t37 = !disabled && !readOnly && openButton ? (0, import_jsx_runtime2.jsx)(Box2, { "aria-hidden": expanded, padding: openButtonBoxPadding, children: (0, import_jsx_runtime2.jsx)(Button2, { "aria-label": "Open", disabled: expanded, fontSize: fontSize2, icon: ChevronDownIcon, mode: "bleed", padding: openButtonPadding, ...openButtonProps, onClick: handleOpenClick }) }) : void 0, $[98] = disabled, $[99] = expanded, $[100] = fontSize2, $[101] = handleOpenClick, $[102] = openButton, $[103] = openButtonBoxPadding, $[104] = openButtonPadding, $[105] = openButtonProps, $[106] = readOnly, $[107] = t37) : t37 = $[107];
  ...
  bb2: {
    ...
    if ($[114] !== activeValue || $[115] !== currentOption || $[116] !== filteredOptions || $[117] !== handleOptionSelect || $[118] !== id || $[119] !== listFocused || $[120] !== loading || $[121] !== renderOption) {
      ...
      $[123] !== activeValue || $[124] !== currentOption || $[125] !== handleOptionSelect || $[126] !== id || $[127] !== listFocused || $[128] !== loading || $[129] !== renderOption ? (t423 = (option_0) => {
        ...
        return (0, import_jsx_runtime2.jsx)(AutocompleteOption, { id: `${id}-option-${option_0.value}`, onSelect: handleOptionSelect, selected: active, value: option_0.value, children: (0, import_react3.cloneElement)(renderOption(option_0), {
          disabled: loading,
          selected: active,
      ...
      t412 = $[122];
    let t422;
    $[131] !== listBoxId || $[132] !== t412 ? (t422 = (0, import_jsx_runtime2.jsx)(Stack2, { as: "ul", "aria-multiselectable": false, "data-ui": "AutoComplete__resultsList", id: listBoxId, ref: listBoxElementRef, role: "listbox", space: 1, children: t412 }), $[131] = listBoxId, $[132] = t412, $[133] = t422) : t422 = $[133];
    let t432;
  ...
  const results = t41, t42 = loading && AnimatedSpinnerIcon, t43 = suffix2 || openButtonNode;
  let t44;
  $[153] !== activeItemId || $[154] !== border2 || $[155] !== clearButton || $[156] !== customValidity || $[157] !== disabled || $[158] !== expanded || $[159] !== fontSize2 || $[160] !== handleClearButtonClick || $[161] !== handleInputChange || $[162] !== handleInputFocus || $[163] !== icon || $[164] !== id || $[165] !== inputValue || $[166] !== listBoxId || $[167] !== padding || $[168] !== prefix3 || $[169] !== radius || $[170] !== readOnly || $[171] !== restProps || $[172] !== t42 || $[173] !== t43 ? (t44 = (0, import_jsx_runtime2.jsx)(TextInput, { ...restProps, "aria-activedescendant": activeItemId, "aria-autocomplete": "list", "aria-expanded": expanded, "aria-owns": listBoxId, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", border: border2, clearButton, customValidity, disabled, fontSize: fontSize2, icon, iconRight: t42, id, inputMode: "search", onChange: handleInputChange, onClear: handleClearButtonClick, onFocus: handleInputFocus, padding, prefix: prefix3, radius, readOnly, ref: setInputElement, role: "combobox", spellCheck: false, suffix: t43, value: inputValue }), $[153] = activeItemId, $[154] = border2, $[155] = clearButton, $[156] = customValidity, $[157] = disabled, $[158] = expanded, $[159] = fontSize2, $[160] = handleClearButtonClick, $[161] = handleInputChange, $[162] = handleInputFocus, $[163] = icon, $[164] = id, $[165] = inputValue, $[166] = listBoxId, $[167] = padding, $[168] = prefix3, $[169] = radius, $[170] = readOnly, $[171] = restProps, $[172] = t42, $[173] = t43, $[174] = t44) : t44 = $[174];
  let t45;
...
var ExpandButton = dt(Button2).withConfig({
  displayName: "ExpandButton",
  componentId: "sc-1es8h8q-1"
})`appearance:none;margin:-4px;`;
var Breadcrumbs = (0, import_react3.forwardRef)(function(props, ref2) {
  ...
  const space2 = t1, [open, setOpen] = (0, import_react3.useState)(false), expandElementRef = (0, import_react3.useRef)(null), popoverElementRef = (0, import_react3.useRef)(null);
  let t2;
  ...
  let t5;
  $[11] !== children ? (t5 = import_react3.Children.toArray(children).filter(import_react3.isValidElement), $[11] = children, $[12] = t5) : t5 = $[12];
  const rawItems = t5;
  let t6;
  $[13] !== maxLength || $[14] !== open || $[15] !== rawItems || $[16] !== space2 ? (t6 = {
    collapse,
    expand: expand3,
    expandElementRef,
    maxLength,
    ...
    rawItems,
    space: space2
  }, $[13] = maxLength, $[14] = open, $[15] = rawItems, $[16] = space2, $[17] = t6) : t6 = $[17];
  const items = useItems(t6);
  let t7;
  if ($[18] !== items || $[19] !== separator || $[20] !== space2) {
    let t82;
    $[22] !== separator || $[23] !== space2 ? (t82 = (item, itemIndex) => (0, import_jsx_runtime2.jsxs)(import_react3.Fragment, { children: [
      itemIndex > 0 && (0, import_jsx_runtime2.jsx)(Box2, { "aria-hidden": true, as: "li", paddingX: space2, children: separator || (0, import_jsx_runtime2.jsx)(Text2, { muted: true, children: "/" }) }),
      (0, import_jsx_runtime2.jsx)(Box2, { as: "li", children: item })
    ] }, itemIndex), $[22] = separator, $[23] = space2, $[24] = t82) : t82 = $[24], t7 = items.map(t82), $[18] = items, $[19] = separator, $[20] = space2, $[21] = t7;
  } else
    t7 = $[21];
  let t8;
  return $[25] !== ref2 || $[26] !== restProps || $[27] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(StyledBreadcrumbs, { "data-ui": "Breadcrumbs", ...restProps, ref: ref2, children: t7 }), $[25] = ref2, $[26] = restProps, $[27] = t7, $[28] = t8) : t8 = $[28], t8;
});
...
function useItems(t0) {
  ...
  if (maxLength && len > maxLength) {
    ...
    let t1;
    if ($[0] !== afterLength || $[1] !== beforeLength || $[2] !== collapse || $[3] !== expand3 || $[4] !== expandElementRef || $[5] !== len || $[6] !== open || $[7] !== popoverElementRef || $[8] !== rawItems || $[9] !== space2) {
      ...
      let t4;
      $[16] !== space2 || $[17] !== t3 ? (t4 = (0, import_jsx_runtime2.jsx)(Stack2, { as: "ol", overflow: "auto", padding: space2, space: space2, children: t3 }), $[16] = space2, $[17] = t3, $[18] = t4) : t4 = $[18];
      const t5 = open ? collapse : expand3;
      let t6;
...
function useDialog() {
  return (0, import_react3.useContext)(DialogContext);
}
...
var DialogContainer = dt(Container2).withConfig({
...
var DialogCardRoot = dt(Card2).withConfig({
...
var DialogLayout = dt(Flex2).withConfig({
  displayName: "DialogLayout",
  componentId: "sc-4n4xb3-3"
})`flex:1;min-height:0;width:100%;`;
var DialogHeader = dt(Box2).withConfig({
  displayName: "DialogHeader",
  componentId: "sc-4n4xb3-4"
})`position:relative;z-index:2;`;
var DialogContent = dt(Box2).withConfig({
  displayName: "DialogContent",
  componentId: "sc-4n4xb3-5"
})`position:relative;z-index:1;overflow:auto;outline:none;`;
var DialogFooter = dt(Box2).withConfig({
  displayName: "DialogFooter",
  componentId: "sc-4n4xb3-6"
})`position:relative;z-index:3;`;
var DialogCard = (0, import_react3.forwardRef)(function(props, forwardedRef) {
  var _a;
  ...
  const width = t2, ref2 = (0, import_react3.useRef)(null), contentRef = (0, import_react3.useRef)(null), layer = useLayer(), {
    isTopLayer
  } = layer, labelId = `${id}_label`, showCloseButton = !!onClose && hideCloseButton === false, showHeader = !!header || showCloseButton;
  let t3;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => ref2.current, $[6] = t3) : t3 = $[6], (0, import_react3.useImperativeHandle)(forwardedRef, t3);
  let t4;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => contentRef.current, $[7] = t4) : t4 = $[7], (0, import_react3.useImperativeHandle)(forwardedContentRef, t4);
  let t5, t6;
  $[8] !== autoFocus ? (t5 = () => {
    autoFocus && ref2.current && focusFirstDescendant(ref2.current);
  }, t6 = [autoFocus, ref2], $[8] = autoFocus, $[9] = t5, $[10] = t6) : (t5 = $[9], t6 = $[10]), (0, import_react3.useEffect)(t5, t6);
  let t7;
  ...
  let t9;
  $[21] === Symbol.for("react.memo_cache_sentinel") ? (t9 = () => [ref2.current], $[21] = t9) : t9 = $[21], useClickOutsideEvent(t8, t9);
  let t10;
  $[22] !== header || $[23] !== labelId || $[24] !== onClose || $[25] !== showCloseButton || $[26] !== showHeader ? (t10 = showHeader && (0, import_jsx_runtime2.jsx)(DialogHeader, { children: (0, import_jsx_runtime2.jsxs)(Flex2, { align: "flex-start", padding: 3, children: [
    (0, import_jsx_runtime2.jsx)(Box2, { flex: 1, padding: 2, children: header && (0, import_jsx_runtime2.jsx)(Text2, { id: labelId, size: 1, weight: "semibold", children: header }) }),
    showCloseButton && (0, import_jsx_runtime2.jsx)(Box2, { flex: "none", children: (0, import_jsx_runtime2.jsx)(Button2, { "aria-label": "Close dialog", disabled: !onClose, icon: CloseIcon, mode: "bleed", onClick: onClose, padding: 2 }) })
  ...
  let t14;
  $[36] !== radius || $[37] !== scheme || $[38] !== shadow || $[39] !== t13 ? (t14 = (0, import_jsx_runtime2.jsx)(DialogCardRoot, { radius, ref: ref2, scheme, shadow, children: t13 }), $[36] = radius, $[37] = scheme, $[38] = shadow, $[39] = t13, $[40] = t14) : t14 = $[40];
  let t15;
...
var Dialog = (0, import_react3.forwardRef)(function(props, ref2) {
  var _a;
  ...
  const zOffset = t11, preDivRef = (0, import_react3.useRef)(null), postDivRef = (0, import_react3.useRef)(null), cardRef = (0, import_react3.useRef)(null), focusedElementRef = (0, import_react3.useRef)(null);
  let t12;
  ...
  const handleFocus = t12, labelId = `${id}_label`, rootClickTimeoutRef = (0, import_react3.useRef)(void 0);
  let t13;
  ...
  let t17;
  $[54] !== animate || $[55] !== handleFocus || $[56] !== handleRootClick || $[57] !== id || $[58] !== labelId || $[59] !== onActivate || $[60] !== padding || $[61] !== position2 || $[62] !== ref2 || $[63] !== restProps || $[64] !== t15 || $[65] !== zOffset ? (t17 = (0, import_jsx_runtime2.jsxs)(StyledDialog, { ...restProps, $animate: animate, $padding: padding, $position: position2, "aria-labelledby": labelId, "aria-modal": true, "data-ui": "Dialog", id, onActivate, onClick: handleRootClick, onFocus: handleFocus, ref: ref2, role: "dialog", zOffset, children: [
    t14,
    t15,
    t16
  ] }), $[54] = animate, $[55] = handleFocus, $[56] = handleRootClick, $[57] = id, $[58] = labelId, $[59] = onActivate, $[60] = padding, $[61] = position2, $[62] = ref2, $[63] = restProps, $[64] = t15, $[65] = zOffset, $[66] = t17) : t17 = $[66];
  let t18;
...
function DialogProvider(props) {
  ...
  let t0;
  $[0] !== position2 || $[1] !== zOffset ? (t0 = {
    version: 0,
    position: position2,
    zOffset
  }, $[0] = position2, $[1] = zOffset, $[2] = t0) : t0 = $[2];
...
var MenuButton = (0, import_react3.forwardRef)(function(props, forwardedRef) {
  ...
  } = props, disableRestoreFocusOnClose = t0 === void 0 ? false : t0, deprecated_portal = t1 === void 0 ? true : t1, [open, setOpen] = (0, import_react3.useState)(false), [shouldFocus, setShouldFocus] = (0, import_react3.useState)(null), [buttonElement, setButtonElement] = (0, import_react3.useState)(null);
  let t2;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $[0] = t2) : t2 = $[0];
  const [menuElements, setChildMenuElements] = (0, import_react3.useState)(t2), openRef = (0, import_react3.useRef)(open);
  let t3, t4;
  $[1] !== onOpen || $[2] !== open ? (t3 = () => {
    onOpen && open && !openRef.current && onOpen();
  }, t4 = [onOpen, open], $[1] = onOpen, $[2] = open, $[3] = t3, $[4] = t4) : (t3 = $[3], t4 = $[4]), (0, import_react3.useEffect)(t3, t4);
  let t5, t6;
  $[5] !== onClose || $[6] !== open ? (t5 = () => {
    onClose && !open && openRef.current && onClose();
  }, t6 = [onClose, open], $[5] = onClose, $[6] = open, $[7] = t5, $[8] = t6) : (t5 = $[7], t6 = $[8]), (0, import_react3.useEffect)(t5, t6);
  let t7, t8;
  $[9] !== open ? (t7 = () => {
    openRef.current = open;
  }, t8 = [open], $[9] = open, $[10] = t7, $[11] = t8) : (t7 = $[10], t8 = $[11]), (0, import_react3.useEffect)(t7, t8);
  let t9;
  ...
  let t17;
  $[28] !== buttonElement || $[29] !== handleBlur || $[30] !== handleItemClick || $[31] !== handleMenuClickOutside || $[32] !== handleMenuEscape || $[33] !== id || $[34] !== menuProp || $[35] !== shouldFocus ? (t17 = menuProp && (0, import_react3.cloneElement)(menuProp, {
    "aria-labelledby": id,
  ...
  const menu = t17;
  let t18;
  $[37] !== buttonProp || $[38] !== handleMouseDown || $[39] !== id || $[40] !== open ? (t18 = buttonProp && (0, import_react3.cloneElement)(buttonProp, {
    "data-ui": "MenuButton",
    id,
  ...
  const button = t18;
  let t19, t20;
  $[42] !== buttonElement ? (t19 = () => buttonElement, t20 = [buttonElement], $[42] = buttonElement, $[43] = t19, $[44] = t20) : (t19 = $[43], t20 = $[44]), (0, import_react3.useImperativeHandle)(forwardedRef, t19, t20);
  let t21;
...
`;
var StyledSkeleton$1 = dt(Box2).withConfig({
  displayName: "StyledSkeleton",
  componentId: "sc-ebtpni-0"
})(responsiveRadiusStyle, skeletonStyle);
var Skeleton = (0, import_react3.forwardRef)(function(props, ref2) {
  ...
  const animated = t0 === void 0 ? false : t0, [visible, setVisible] = (0, import_react3.useState)(!delay);
  let t1, t2;
  $[5] !== delay ? (t1 = () => {
    if (!delay)
      return;
  ...
  }, t2 = [delay], $[5] = delay, $[6] = t1, $[7] = t2) : (t1 = $[6], t2 = $[7]), (0, import_react3.useEffect)(t1, t2);
  let t3;
  $[8] !== radius ? (t3 = _getArrayProp(radius), $[8] = radius, $[9] = t3) : t3 = $[9];
  const t4 = delay ? visible : true;
  let t5;
  return $[10] !== animated || $[11] !== ref2 || $[12] !== restProps || $[13] !== t3 || $[14] !== t4 ? (t5 = (0, import_jsx_runtime2.jsx)(StyledSkeleton$1, { ...restProps, $animated: animated, $radius: t3, $visible: t4, ref: ref2 }), $[10] = animated, $[11] = ref2, $[12] = restProps, $[13] = t3, $[14] = t4, $[15] = t5) : t5 = $[15], t5;
});
...
var TextSkeleton = (0, import_react3.forwardRef)(function(props, ref2) {
  ...
  const $size = t1;
  let t2;
  return $[5] !== $size || $[6] !== ref2 || $[7] !== restProps ? (t2 = (0, import_jsx_runtime2.jsx)(StyledSkeleton, { ...restProps, $size, ref: ref2, $style: "text" }), $[5] = $size, $[6] = ref2, $[7] = restProps, $[8] = t2) : t2 = $[8], t2;
});
TextSkeleton.displayName = "ForwardRef(TextSkeleton)";
var LabelSkeleton = (0, import_react3.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime2.c)(9);
  let restProps, t0;
  $[0] !== props ? ({
    size: t0,
  ...
  const $size = t1;
  let t2;
  return $[5] !== $size || $[6] !== ref2 || $[7] !== restProps ? (t2 = (0, import_jsx_runtime2.jsx)(StyledSkeleton, { ...restProps, $size, ref: ref2, $style: "label" }), $[5] = $size, $[6] = ref2, $[7] = restProps, $[8] = t2) : t2 = $[8], t2;
});
LabelSkeleton.displayName = "ForwardRef(LabelSkeleton)";
var HeadingSkeleton = (0, import_react3.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime2.c)(9);
  let restProps, t0;
  $[0] !== props ? ({
    size: t0,
  ...
  const $size = t1;
  let t2;
  return $[5] !== $size || $[6] !== ref2 || $[7] !== restProps ? (t2 = (0, import_jsx_runtime2.jsx)(StyledSkeleton, { ...restProps, $size, ref: ref2, $style: "heading" }), $[5] = $size, $[6] = ref2, $[7] = restProps, $[8] = t2) : t2 = $[8], t2;
});
HeadingSkeleton.displayName = "ForwardRef(HeadingSkeleton)";
var CodeSkeleton = (0, import_react3.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime2.c)(9);
  let restProps, t0;
  $[0] !== props ? ({
    size: t0,
  ...
  const $size = t1;
  let t2;
  return $[5] !== $size || $[6] !== ref2 || $[7] !== restProps ? (t2 = (0, import_jsx_runtime2.jsx)(StyledSkeleton, { ...restProps, $size, ref: ref2, $style: "code" }), $[5] = $size, $[6] = ref2, $[7] = restProps, $[8] = t2) : t2 = $[8], t2;
});
CodeSkeleton.displayName = "ForwardRef(CodeSkeleton)";
var TabPanel = (0, import_react3.forwardRef)(function(props, ref2) {
  const $ = (0, import_react_compiler_runtime2.c)(9);
  let flex, restProps;
  $[0] !== props ? ({
    flex,
  ...
  let t1;
  return $[3] !== flex || $[4] !== props.children || $[5] !== ref2 || $[6] !== restProps || $[7] !== t0 ? (t1 = (0, import_jsx_runtime2.jsx)(Box2, { "data-ui": "TabPanel", ...restProps, flex, ref: ref2, role: "tabpanel", tabIndex: t0, children: props.children }), $[3] = flex, $[4] = props.children, $[5] = ref2, $[6] = restProps, $[7] = t0, $[8] = t1) : t1 = $[8], t1;
});
...
var TextBox = dt(Flex2).withConfig({
  displayName: "TextBox",
  componentId: "sc-1rr7rxo-0"
})`overflow-x:auto;`;
var StyledToast = dt(Card2).withConfig({
...
var LoadingBarMask = dt(Card2).withConfig({
...
var LoadingBarProgress = dt(Card2).withConfig({
...
function Toast(props) {
  ...
  const radius = t0 === void 0 ? 3 : t0, cardTone2 = status ? STATUS_CARD_TONE[status] : "default", buttonTone = status ? BUTTON_TONE[status] : "default", role = status ? ROLES[status] : "status", visualDuration = usePrefersReducedMotion() ? 0 : 0.26;
  let t1;
  ...
  let t6;
  $[15] !== title ? (t6 = title && (0, import_jsx_runtime2.jsx)(Text2, { size: 1, weight: "medium", children: title }), $[15] = title, $[16] = t6) : t6 = $[16];
  let t7;
  ...
  let t8;
  $[20] !== t6 || $[21] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(TextBox, { flex: 1, padding: 3, children: (0, import_jsx_runtime2.jsxs)(Stack2, { space: 3, children: [
    t6,
    t7
  ] }) }), $[20] = t6, $[21] = t7, $[22] = t8) : t8 = $[22];
  let t9;
  $[23] !== buttonTone || $[24] !== closable || $[25] !== onClose ? (t9 = closable && (0, import_jsx_runtime2.jsx)(Box2, { padding: 1, children: (0, import_jsx_runtime2.jsx)(Button2, { as: "button", icon: CloseIcon, mode: "bleed", padding: 2, tone: buttonTone, onClick: onClose, style: {
    verticalAlign: "top"
  ...
  let t11;
  $[31] !== cardTone2 || $[32] !== duration || $[33] !== hasDuration || $[34] !== onClose || $[35] !== radius || $[36] !== transition || $[37] !== updatedAt || $[38] !== visualDuration ? (t11 = hasDuration && (0, import_jsx_runtime2.jsxs)(MotionLoadingBar, { variants: content, transition, children: [
    (0, import_jsx_runtime2.jsx)(LoadingBarMask, { tone: cardTone2, radius }),
    (0, import_jsx_runtime2.jsx)(MotionLoadingBarProgress, { tone: cardTone2, initial: {
      scaleX: 0
    }, animate: {
      scaleX: 1
    }, transition: {
  ...
  ] }), $[31] = cardTone2, $[32] = duration, $[33] = hasDuration, $[34] = onClose, $[35] = radius, $[36] = transition, $[37] = updatedAt, $[38] = visualDuration, $[39] = t11) : t11 = $[39];
  let t12;
  return $[40] !== cardTone2 || $[41] !== radius || $[42] !== restProps || $[43] !== role || $[44] !== t10 || $[45] !== t11 || $[46] !== t5 || $[47] !== transition || $[48] !== visualDuration ? (t12 = (0, import_jsx_runtime2.jsxs)(MotionToast, { "data-ui": "Toast", role, ...restProps, "data-has-duration": t5, custom: visualDuration, radius, shadow: 2, tone: cardTone2, forwardedAs: "li", layout: "position", variants: container, initial, animate, exit, transition, children: [
    t10,
    t11
  ] }), $[40] = cardTone2, $[41] = radius, $[42] = restProps, $[43] = role, $[44] = t10, $[45] = t11, $[46] = t5, $[47] = transition, $[48] = visualDuration, $[49] = t12) : t12 = $[49], t12;
}
...
var MotionFlex2 = motion.create(Flex2);
var MotionText = motion.create(Text2);
var MotionLoadingBar = motion.create(LoadingBar);
var MotionLoadingBarProgress = motion.create(LoadingBarProgress);
function useMounted() {
  return (0, import_react3.useSyncExternalStore)(subscribe, _temp$12, _temp22);
}
function _temp22() {
  return false;
}
...
function ToastProvider(props) {
  ...
  const [state, setState] = (0, import_react3.useState)(t1), mounted = useMounted();
  let t2;
  $[1] === Symbol.for("react.memo_cache_sentinel") ? (t2 = {
    version: 0,
    push: (params) => {
      const id = params.id || generateToastId(), duration = params.duration || 5e3;
      return (0, import_react3.startTransition)(() => {
        setState((prevState) => {
          if (duration === 0.01)
            return prevState.filter((toast) => toast.id !== id);
          const dismiss = () => (0, import_react3.startTransition)(() => setState((currentState) => currentState.filter((toast_0) => toast_0.id !== id)));
...
var Tree = (0, import_react3.forwardRef)(function(props, forwardedRef) {
  ...
  const space2 = t0 === void 0 ? 1 : t0, ref2 = (0, import_react3.useRef)(null), [focusedElement, setFocusedElement] = (0, import_react3.useState)(null), focusedElementRef = (0, import_react3.useRef)(focusedElement);
  let t1;
  $[5] === Symbol.for("react.memo_cache_sentinel") ? (t1 = [], $[5] = t1) : t1 = $[5];
  const path = t1;
  let t2;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $[6] = t2) : t2 = $[6];
  const [itemElements, setItemElements] = (0, import_react3.useState)(t2);
  let t3;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t3 = {}, $[7] = t3) : t3 = $[7];
  const [state, setState] = (0, import_react3.useState)(t3), stateRef = (0, import_react3.useRef)(state);
  let t4;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref2.current, $[8] = t4) : t4 = $[8], (0, import_react3.useImperativeHandle)(forwardedRef, t4);
  let t5, t6;
  $[9] !== focusedElement ? (t5 = () => {
    focusedElementRef.current = focusedElement;
  }, t6 = [focusedElement], $[9] = focusedElement, $[10] = t5, $[11] = t6) : (t5 = $[10], t6 = $[11]), (0, import_react3.useEffect)(t5, t6);
  let t7, t8;
  $[12] !== state ? (t7 = () => {
    stateRef.current = state;
  }, t8 = [state], $[12] = state, $[13] = t7, $[14] = t8) : (t7 = $[13], t8 = $[14]), (0, import_react3.useEffect)(t7, t8);
  let t9;
  ...
  $[17] !== space2 || $[18] !== state || $[19] !== t11 ? (t12 = {
    ...
    space: space2,
    state
  }, $[17] = space2, $[18] = state, $[19] = t11, $[20] = t12) : t12 = $[20];
  ...
  $[25] === Symbol.for("react.memo_cache_sentinel") ? (t15 = () => {
    if (!ref2.current)
      return;
    const _itemElements = Array.from(ref2.current.querySelectorAll('[data-ui="TreeItem"]'));
    setItemElements(_itemElements);
  }, $[25] = t15) : t15 = $[25];
  let t16;
  $[26] !== children ? (t16 = [children], $[26] = children, $[27] = t16) : t16 = $[27], (0, import_react3.useEffect)(t15, t16);
  let t17;
  $[28] !== children || $[29] !== handleFocus || $[30] !== handleKeyDown || $[31] !== restProps || $[32] !== space2 ? (t17 = (0, import_jsx_runtime2.jsx)(Stack2, { as: "ul", "data-ui": "Tree", ...restProps, onFocus: handleFocus, onKeyDown: handleKeyDown, ref: ref2, role: "tree", space: space2, children }), $[28] = children, $[29] = handleFocus, $[30] = handleKeyDown, $[31] = restProps, $[32] = space2, $[33] = t17) : t17 = $[33];
  let t18;
...
function useTree() {
  const tree = (0, import_react3.useContext)(TreeContext);
  if (!tree)
...
function TreeGroup(props) {
  ...
  let t2;
  return $[4] !== children || $[5] !== restProps || $[6] !== t1 || $[7] !== tree.space ? (t2 = (0, import_jsx_runtime2.jsx)(Stack2, { as: "ul", "data-ui": "TreeGroup", ...restProps, hidden: t1, marginTop: tree.space, role: "group", space: tree.space, children }), $[4] = children, $[5] = restProps, $[6] = t1, $[7] = tree.space, $[8] = t2) : t2 = $[8], t2;
}
...
var TreeItemBox = dt(Box2).attrs({
  forwardedAs: "a"
}).withConfig({
  displayName: "TreeItemBox",
  componentId: "sc-iiskig-1"
})(treeItemBoxStyle);
var ToggleArrowText = dt(Text2).withConfig({
...
function TreeItem(props) {
  ...
  const expandedProp = t0 === void 0 ? false : t0, fontSize2 = t1 === void 0 ? 1 : t1, padding = t2 === void 0 ? 2 : t2, selected = t3 === void 0 ? false : t3, space2 = t4 === void 0 ? 2 : t4, [rootElement, _setRootElement] = (0, import_react3.useState)(null);
  let t5;
  $[16] === Symbol.for("react.memo_cache_sentinel") ? (t5 = (node2) => {
    (0, import_react3.startTransition)(() => _setRootElement(node2));
  }, $[16] = t5) : t5 = $[16];
  const setRootElement = t5, treeitemRef = (0, import_react3.useRef)(null), tree = useTree(), {
    path,
    registerItem,
    setExpanded,
    setFocusedElement
  } = tree, _id = (0, import_react3.useId)(), id = idProp || _id;
  let t6, t7;
  if ($[17] !== id || $[18] !== path) {
  ...
  }, t14 = [expanded, itemKey, registerItem, rootElement, selected], $[38] = expanded, $[39] = itemKey, $[40] = registerItem, $[41] = rootElement, $[42] = selected, $[43] = t13, $[44] = t14) : (t13 = $[43], t14 = $[44]), (0, import_react3.useEffect)(t13, t14);
  ...
  let t17;
  $[47] !== IconComponent || $[48] !== fontSize2 || $[49] !== muted || $[50] !== weight ? (t17 = IconComponent && (0, import_jsx_runtime2.jsx)(Text2, { muted, size: fontSize2, weight, children: (0, import_jsx_runtime2.jsx)(IconComponent, {}) }), $[47] = IconComponent, $[48] = fontSize2, $[49] = muted, $[50] = weight, $[51] = t17) : t17 = $[51];
  let t18;
  ...
  let t19;
  $[58] !== space2 || $[59] !== t16 || $[60] !== t17 || $[61] !== t18 ? (t19 = (0, import_jsx_runtime2.jsxs)(Box2, { marginRight: space2, style: t16, children: [
    t17,
    t18
  ] }), $[58] = space2, $[59] = t16, $[60] = t17, $[61] = t18, $[62] = t19) : t19 = $[62];
  let t20;
  $[63] !== fontSize2 || $[64] !== muted || $[65] !== text || $[66] !== weight ? (t20 = (0, import_jsx_runtime2.jsx)(Box2, { flex: 1, children: (0, import_jsx_runtime2.jsx)(Text2, { muted, size: fontSize2, textOverflow: "ellipsis", weight, children: text }) }), $[63] = fontSize2, $[64] = muted, $[65] = text, $[66] = weight, $[67] = t20) : t20 = $[67];
  let t21;
  $[68] !== padding || $[69] !== t19 || $[70] !== t20 ? (t21 = (0, import_jsx_runtime2.jsxs)(Flex2, { padding, children: [
    t19,
    t20
...
function Feedback(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(Card2, { tone, padding: 4, radius: 3, border: true, children: (0, import_jsx_runtime3.jsxs)(Flex2, { children: [
    icon ? "display icon" : null,
    children || (0, import_jsx_runtime3.jsx)(Box2, { flex: 1, children: (0, import_jsx_runtime3.jsxs)(Stack2, { space: 4, children: [
      title ? (0, import_jsx_runtime3.jsx)(Text2, { weight: "semibold", children: title }) : null,
      description ? (0, import_jsx_runtime3.jsx)(Text2, { size: 2, children: description }) : null
    ] }) })
  ] }) });
}
...
var TableWrapper = (props = {}) => (0, import_jsx_runtime3.jsx)(Card2, __spreadValues$2({ as: "table" }, props));
...
var RowWrapper = (props = {}) => (0, import_jsx_runtime3.jsx)(Card2, __spreadValues$2({ as: "tr" }, props));
...
var CellWrapper = (props = {}) => (0, import_jsx_runtime3.jsx)(Card2, __spreadValues$2({ as: "td" }, props));
...
function requireUrlForImage() {
  return hasRequiredUrlForImage || (hasRequiredUrlForImage = 1, function(exports) {
    ...
    function specToImageUrl(spec) {
      ...
      return flip2 && params.push("flip=".concat(flip2)), exports.SPEC_NAME_TO_URL_NAME_MAPPINGS.forEach(function(mapping) {
...
function useParams(params) {
  const stringifiedParams = (0, import_react5.useMemo)(
    () => JSON.stringify(params || {}),
    [params]
  );
  return (0, import_react5.useMemo)(() => JSON.parse(stringifiedParams), [stringifiedParams]);
}
function useListeningQuery(query, {
  ...
  const [loading, setLoading] = (0, import_react5.useState)(true), [error2, setError] = (0, import_react5.useState)(false), [data, setData] = (0, import_react5.useState)(initialValue), memoParams = useParams(params), memoOptions = useParams(options), subscription = (0, import_react5.useRef)(null), documentStore = useDocumentStore();
  return (0, import_react5.useEffect)(() => {
    if (query && !error2 && !subscription.current)
      try {
    ...
    return error2 && subscription.current && subscription.current.unsubscribe(), () => {
      var _a;
      subscription.current && ((_a = subscription == null ? void 0 : subscription.current) == null || _a.unsubscribe(), subscription.current = null);
    };
  }, [query, error2, memoParams, memoOptions, documentStore]), { data, loading, error: error2 };
}
...
function connect(mapStateToProps, mapDispatchToProps2, mergeProps, {
  ...
  const wrapWithConnect = (WrappedComponent) => {
    if (true) {
      const isValid = isValidElementType2(WrappedComponent);
      if (!isValid)
        throw new Error(
...
function useMemo3(getResult, inputs) {
  const initial = (0, import_react6.useState)(() => ({
    inputs,
    result: getResult()
  }))[0];
  const isFirstRun = (0, import_react6.useRef)(true);
  const committed = (0, import_react6.useRef)(initial);
...
function useCallback3(callback, inputs) {
  return useMemo3(() => callback, inputs);
}
var origin2 = {
  x: 0,
  y: 0
...
function memoizeOne(resultFn, isEqual3 = areInputsEqual) {
  let cache2 = null;
...
var getDroppableDisplaced = (target, destination) => {
  const displacement = destination.frame ? destination.frame.scroll.diff.displacement : origin2;
...
var getCombinedItemDisplacement = ({
  ...
  if (didStartAfterCritical(combineWith, afterCritical)) {
    return isDisplaced ? origin2 : negate(displacedBy.point);
  }
  return isDisplaced ? displacedBy.point : origin2;
};
var whenCombining = ({
  afterCritical,
  impact,
...
var moveTo = (offset4) => isEqual$1(offset4, origin2) ? void 0 : `translate(${offset4.x}px, ${offset4.y}px)`;
var transforms = {
  moveTo,
...
function createPublisher({
  ...
  const collect = () => {
    ...
    frameId = requestAnimationFrame(() => {
      ...
      const added = Object.keys(additions).map((id) => registry.draggable.getById(id).getDimension(origin2)).sort((a, b) => a.descriptor.index - b.descriptor.index);
...
var getDistanceThresholds = (container2, axis, getAutoScrollerOptions = () => defaultAutoScrollerOptions) => {
  const autoScrollerOptions = getAutoScrollerOptions();
  const startScrollingFrom = container2[axis.size] * autoScrollerOptions.startFromPercentage;
  const maxScrollValueAt = container2[axis.size] * autoScrollerOptions.maxScrollAtPercentage;
  const thresholds = {
    startScrollingFrom,
    maxScrollValueAt
  };
...
var getPercentage = ({
  ...
  const percentage = currentInRange / range2;
  return percentage;
};
var minScroll = 1;
...
var getScrollOnAxis = ({
  ...
  const thresholds = getDistanceThresholds(container2, axis, getAutoScrollerOptions);
...
var adjustForSizeLimits = ({
  ...
  const isTooBigVertically = subject.height > container2.height;
  const isTooBigHorizontally = subject.width > container2.width;
...
var getScroll$1 = ({
  ...
  if (isEqual$1(required2, origin2)) {
    return null;
  }
  ...
  return isEqual$1(limited, origin2) ? null : limited;
};
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined" ? import_react6.useLayoutEffect : import_react6.useEffect;
var getHead = () => {
...
function useUniqueId(prefix3, options = defaults) {
  const id = import_react6.default.useId();
...
function useSensorMarshal({
  ...
  const lockAPI = (0, import_react6.useState)(() => create())[0];
...
var createResponders = (props) => ({
  onBeforeCapture: (t) => {
    ...
    (0, import_react_dom3.flushSync)(onBeforeCapureCallback);
  },
...
function getDimension$1(descriptor, el, windowScroll = origin2) {
...
var Draggable = (props) => {
  ...
  const onMoveEnd = useCallback3((event) => {
    ...
    (0, import_react_dom3.flushSync)(dropAnimationFinishedAction);
...
function getSecondarySelector() {
  ...
  const getFallback = (combineTargetFor) => {
    return combineTargetFor ? getMemoizedProps(origin2, combineTargetFor, true) : null;
  };
...
var Droppable = (props) => {
  ...
  const placeholder2 = useMemo3(() => import_react6.default.createElement(AnimateInOut, {
  ...
  function getClone() {
    ...
    const node2 = import_react6.default.createElement(PrivateDraggable, {
    ...
    return import_react_dom3.default.createPortal(node2, getContainerForClone());
  }
...
// node_modules/@sanity/orderable-document-list/lib/index.js
var ORDER_FIELD_NAME = "orderRank";
var API_VERSION = "v2025-06-27";
function initialRank(compareRankValue = "", newItemPosition = "after") {
  const compareRank = compareRankValue ? import_lexorank.LexoRank.parse(compareRankValue) : import_lexorank.LexoRank.min();
  return (newItemPosition === "before" ? compareRank.genPrev().genPrev() : compareRank.genNext().genNext()).toString();
}
var orderRankField = (config) => {
  ...
  return defineField({
    ...
    type: "string",
    initialValue: async (p, { getClient: getClient2 }) => {
      const direction = newItemPosition === "before" ? "asc" : "desc", lastDocOrderRank = await getClient2({ apiVersion: API_VERSION }).fetch(
...
var OrderableContext = (0, import_react7.createContext)({});
function Document({
  doc,
  increment,
  entities,
  ...
  var _a, _b;
  const { showIncrements } = (0, import_react7.useContext)(OrderableContext), schema = useSchema(), router = usePaneRouter(), versionsInfo = useDocumentVersionInfo(doc._id), { ChildLink, groupIndex, routerPanesState } = router, currentDoc = ((_b = (_a = routerPanesState[groupIndex + 1]) == null ? void 0 : _a[0]) == null ? void 0 : _b.id) || false, pressed = currentDoc === doc._id || currentDoc === doc._id.replace("drafts.", ""), selected = pressed && routerPanesState.length === groupIndex + 2, Link = (0, import_react7.useMemo)(
    () => function(linkProps) {
      return (0, import_jsx_runtime4.jsx)(ChildLink, { ...linkProps, childId: doc._id });
    },
    [ChildLink, doc._id]
  ), tooltip = (0, import_jsx_runtime4.jsx)(
    DocumentStatus,
    {
  ...
  return (0, import_jsx_runtime4.jsx)(
    PreviewCard,
    {
      ...
      children: (0, import_jsx_runtime4.jsxs)(Flex, { align: "center", children: [
        (0, import_jsx_runtime4.jsx)(Box, { paddingX: 2, style: { flexShrink: 0 }, children: (0, import_jsx_runtime4.jsx)(Text, { size: 2, children: (0, import_jsx_runtime4.jsx)(DragHandleIcon, { cursor: "grab" }) }) }),
        showIncrements && (0, import_jsx_runtime4.jsxs)(Flex, { style: { flexShrink: 0 }, align: "center", gap: 1, paddingRight: 1, children: [
        ...
        (0, import_jsx_runtime4.jsx)(Box, { style: { width: "100%" }, children: (0, import_jsx_runtime4.jsxs)(Flex, { flex: 1, align: "center", justify: "space-between", paddingRight: 3, children: [
          (0, import_jsx_runtime4.jsx)(
            Preview$1,
            {
              layout: "default",
          ...
          (0, import_jsx_runtime4.jsx)(Tooltip, { content: tooltip, portal: true, placement: "right", boundaryElement: null, children: (0, import_jsx_runtime4.jsx)(Flex, { align: "center", children: (0, import_jsx_runtime4.jsx)(
            DocumentStatusIndicator,
            {
              draft: versionsInfo.draft,
              published: versionsInfo.published,
        ...
        dragBadge && (0, import_jsx_runtime4.jsx)(Card, { tone: "default", marginRight: 4, radius: 5, children: (0, import_jsx_runtime4.jsx)(AvatarCounter, { count: dragBadge }) })
      ] })
    }
  );
}
  ...
  const startIndex = source.index, endIndex = destination.index, isMovingUp = startIndex > endIndex, selectedItems = entities.filter((item) => selectedIds.includes(item._id)), message = [
    ...
    (acc, cur, curIndex) => {
      ...
      if (curIndex === endIndex) {
        const prevIndex = curIndex - 1, prevRank = ((_a = entities[prevIndex]) == null ? void 0 : _a[ORDER_FIELD_NAME]) ? import_lexorank.LexoRank.parse((_b = entities[prevIndex]) == null ? void 0 : _b[ORDER_FIELD_NAME]) : import_lexorank.LexoRank.min(), curRank = import_lexorank.LexoRank.parse(entities[curIndex][ORDER_FIELD_NAME]), nextIndex = curIndex + 1, nextRank = ((_c = entities[nextIndex]) == null ? void 0 : _c[ORDER_FIELD_NAME]) ? import_lexorank.LexoRank.parse((_d = entities[nextIndex]) == null ? void 0 : _d[ORDER_FIELD_NAME]) : import_lexorank.LexoRank.max();
...
var getItemStyle = (draggableStyle, itemIsUpdating) => ({
  userSelect: "none",
...
var cardTone = (settings) => {
  const { isDuplicate, isGhosting, isDragging: isDragging2, isSelected } = settings;
  if (isGhosting) return "transparent";
  if (isDragging2 || isSelected) return "primary";
  if (isDuplicate) return "caution";
};
function DraggableList({ data, listIsUpdating, setListIsUpdating }) {
  var _a, _b;
  const toast = useToast(), router = usePaneRouter(), { groupIndex, routerPanesState } = router, currentDoc = ((_b = (_a = routerPanesState[groupIndex + 1]) == null ? void 0 : _a[0]) == null ? void 0 : _b.id) || false, [orderedData, setOrderedData] = (0, import_react7.useState)(data);
  (0, import_react7.useEffect)(() => {
    listIsUpdating || setOrderedData(data);
  }, [data]);
  const [draggingId, setDraggingId] = (0, import_react7.useState)(""), [selectedIds, setSelectedIds] = (0, import_react7.useState)(currentDoc ? [currentDoc] : []), clearSelected = (0, import_react7.useCallback)(() => setSelectedIds([]), [setSelectedIds]), handleSelect = (0, import_react7.useCallback)(
  ...
  ), client = useSanityClient(), transactPatches = (0, import_react7.useCallback)(
    async (patches, message) => {
      ...
      try {
        ...
        clearSelected(), setDraggingId(""), setListIsUpdating(false), toast.push({
          title: `${updated.results.length === 1 ? "1 document" : `${updated.results.length} documents`} reordered`,
          status: "success",
          description: message
        });
      } catch {
        setDraggingId(""), setListIsUpdating(false), toast.push({
  ...
  ), handleDragEnd = (0, import_react7.useCallback)(
    (result, entities) => {
      setDraggingId("");
      const { source, destination, draggableId } = result ?? {};
      if ((source == null ? void 0 : source.index) === (destination == null ? void 0 : destination.index) || !(entities == null ? void 0 : entities.length) || !draggableId) return;
      ...
      setListIsUpdating(true), setSelectedIds(effectedIds);
      ...
      (newOrder == null ? void 0 : newOrder.length) && setOrderedData(newOrder), (patches == null ? void 0 : patches.length) && transactPatches(patches, message);
    },
    [selectedIds, setDraggingId, setSelectedIds, transactPatches, setListIsUpdating]
  ), handleDragStart = (0, import_react7.useCallback)(
    (start2) => {
      const id = start2.draggableId;
      selectedIds.includes(id) || clearSelected(), setDraggingId(id);
    },
    [selectedIds, clearSelected, setDraggingId]
  ), incrementIndex = (0, import_react7.useCallback)(
    ...
    [handleDragEnd]
  ), onWindowKeyDown = (0, import_react7.useCallback)(
    (event) => {
      event.key === "Escape" && clearSelected();
    },
    [clearSelected]
  );
  (0, import_react7.useEffect)(() => (window.addEventListener("keydown", onWindowKeyDown), () => {
    window.removeEventListener("keydown", onWindowKeyDown);
  }), [onWindowKeyDown]);
  const duplicateOrders = (0, import_react7.useMemo)(() => {
  ...
  }, [orderedData]), onDragEnd2 = (0, import_react7.useCallback)(
    (result) => handleDragEnd(result, orderedData),
    [orderedData, handleDragEnd]
  );
  return (0, import_jsx_runtime4.jsx)(DragDropContext, { onDragStart: handleDragStart, onDragEnd: onDragEnd2, children: (0, import_jsx_runtime4.jsx)(ConnectedDroppable, { droppableId: "documentSortZone", children: (provided) => (0, import_jsx_runtime4.jsxs)("div", { ...provided.droppableProps, ref: provided.innerRef, children: [
    orderedData.map((item, index) => (0, import_jsx_runtime4.jsx)(
      PublicDraggable,
      {
        draggableId: item._id,
        index,
        children: (innerProvided, innerSnapshot) => {
          const isSelected = selectedIds.includes(item._id), isDragging2 = innerSnapshot.isDragging, isGhosting = !!(!isDragging2 && draggingId && isSelected), isUpdating = listIsUpdating && isSelected, isDisabled = !item[ORDER_FIELD_NAME], isDuplicate = duplicateOrders.includes(item[ORDER_FIELD_NAME]), tone = cardTone({ isDuplicate, isGhosting, isDragging: isDragging2, isSelected }), selectedCount = selectedIds.length, dragBadge = isDragging2 && selectedCount > 1 ? selectedCount : false;
          return (0, import_jsx_runtime4.jsx)(
            "div",
            {
              ...
              children: (0, import_jsx_runtime4.jsx)(Box, { paddingBottom: 1, children: (0, import_jsx_runtime4.jsx)(
                Card,
                {
                  tone,
                  shadow: isDragging2 ? 2 : void 0,
                  radius: 2,
...
var isVersionForCurrentPerspective = (document2, perspectiveName, publishedId) => document2._id && isVersionId(document2._id) && getVersionFromId(document2._id) === perspectiveName && getPublishedId(document2._id) === publishedId;
var getFilteredDedupedDocs = (documents, perspectiveName) => {
  ...
  return flatDocuments.reduce((acc, cur) => {
    ...
    if (!isDraftId(cur._id)) {
      ...
      ) : false, hasDraft = flatDocuments.some((doc) => doc._id === `drafts.${cur._id}`);
...
function DocumentListQuery(props) {
  const [listIsUpdating, setListIsUpdating] = (0, import_react7.useState)(false), [data, setData] = (0, import_react7.useState)([]), { query, queryParams } = getDocumentQuery(props), {
    data: _queryData,
    loading,
    error: error2
  ...
  const unorderedDataCount = (0, import_react7.useMemo)(
    () => (data == null ? void 0 : data.length) ? data.filter((doc) => !doc[ORDER_FIELD_NAME]).length : 0,
    [data]
  );
  return loading ? (0, import_jsx_runtime4.jsx)(Flex, { style: { width: "100%", height: "100%" }, align: "center", justify: "center", children: (0, import_jsx_runtime4.jsx)(Spinner, {}) }) : error2 ? (0, import_jsx_runtime4.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime4.jsx)(Feedback, { tone: "critical", title: "There was an error", description: "Please try again later" }) }) : !data || (data == null ? void 0 : data.length) == 0 ? (0, import_jsx_runtime4.jsx)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: (0, import_jsx_runtime4.jsx)(Container, { width: 1, children: (0, import_jsx_runtime4.jsx)(Box, { paddingX: 4, paddingY: 5, children: (0, import_jsx_runtime4.jsx)(Text, { align: "center", muted: true, children: "No documents of this type" }) }) }) }) : (0, import_jsx_runtime4.jsx)(Stack, { space: 1, style: { overflow: "auto", height: "100%" }, children: (0, import_jsx_runtime4.jsxs)(Box, { padding: 2, children: [
    unorderedDataCount > 0 && (0, import_jsx_runtime4.jsx)(Box, { marginBottom: 2, children: (0, import_jsx_runtime4.jsx)(
      Feedback,
      {
        tone: "caution",
        description: (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          unorderedDataCount,
          "/",
          data == null ? void 0 : data.length,
          " documents have no order. Select",
          " ",
          (0, import_jsx_runtime4.jsx)("strong", { children: "Reset Order" }),
...
function DocumentListWrapper({
  ...
  (0, import_react7.useEffect)(() => {
    (resetOrderTransaction == null ? void 0 : resetOrderTransaction.title) && (resetOrderTransaction == null ? void 0 : resetOrderTransaction.status) && toast.push(resetOrderTransaction);
  }, [resetOrderTransaction, toast]);
  const schemaIsInvalid = (0, import_react7.useMemo)(() => {
    if (!type)
      return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        "No ",
        (0, import_jsx_runtime4.jsx)("code", { children: "type" }),
        " was configured"
      ] });
    const typeSchema = schema.get(type);
    return typeSchema ? !("fields" in typeSchema) || !typeSchema.fields.some((field) => (field == null ? void 0 : field.name) === ORDER_FIELD_NAME) ? (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      "Schema ",
      (0, import_jsx_runtime4.jsx)("code", { children: type }),
      " must have an ",
      (0, import_jsx_runtime4.jsx)("code", { children: ORDER_FIELD_NAME }),
      " field of type",
      " ",
      (0, import_jsx_runtime4.jsx)("code", { children: "string" })
  ...
  return schemaIsInvalid ? (0, import_jsx_runtime4.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime4.jsx)(Feedback, { description: schemaIsInvalid, tone: "caution" }) }) : (0, import_jsx_runtime4.jsx)(OrderableContext.Provider, { value: { showIncrements }, children: (0, import_jsx_runtime4.jsx)(
    DocumentListQuery,
    {
      type,
      filter,
...
async function resetOrder(params) {
  ...
  if (documents.length === 0)
    return null;
  let aLexoRank = import_lexorank.LexoRank.min();
...
var OrderableDocumentList = class extends import_react7.Component {
  constructor(props) {
    super(props);
    __publicField(this, "actionHandlers", {
      ...
      resetOrder: async () => {
        ...
        const update2 = await resetOrder(this.props.options), reorderWasSuccessful = (_a = update2 == null ? void 0 : update2.results) == null ? void 0 : _a.length;
        this.setState(() => ({
          resetOrderTransaction: {
            status: reorderWasSuccessful ? "success" : "info",
            title: reorderWasSuccessful ? `Reordered ${update2.results.length === 1 ? "Document" : "Documents"}` : "Reordering failed",
            closable: true
          }
        }));
      }
  ...
  render() {
    ...
    return type ? (0, import_jsx_runtime4.jsx)(
      DocumentListWrapper,
      {
        ...
        currentVersion: (_h = (_g = this == null ? void 0 : this.props) == null ? void 0 : _g.options) == null ? void 0 : _h.currentVersion
      }
    ) : null;
  }
};
function orderableDocumentListDeskItem(config) {
  ...
  if (!(config == null ? void 0 : config.type) || !config.context || !config.S)
    ...
    `);
  const { type, filter, menuItems = [], createIntent, params, title, icon, id, context, S } = config, { schema, getClient: getClient2 } = context, perspectiveStack = context.perspectiveStack || [], client = getClient2({ apiVersion: API_VERSION }), currentVersion = perspectiveStack[0], listTitle = title ?? `Orderable ${type}`, listId = id ?? `orderable-${type}`, listIcon = icon ?? SortIcon, typeTitle = ((_a = schema.get(type)) == null ? void 0 : _a.title) ?? type;
  return createIntent !== false && menuItems.push(
...
//# sourceMappingURL=@sanity_orderable-document-list.js.map
